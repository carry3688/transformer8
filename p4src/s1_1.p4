...
const bit<32> wq_3_3 = 0xffff2d7e;
const bit<32> wq_3_4 = 0xffffbb19;
const bit<32> wq_3_5 = 0x00000185;
const bit<32> wq_4_3 = 0xffffad93;
const bit<32> wq_4_4 = 0xffff8cfe;
const bit<32> wq_4_5 = 0xffff891f;
const bit<32> wq_5_3 = 0xfffff077;
const bit<32> wq_5_4 = 0x000020fd;
const bit<32> wq_5_5 = 0x0000d62d;
const bit<32> wk_3_3 = 0xffff220c;
const bit<32> wk_3_4 = 0xffff4097;
const bit<32> wk_3_5 = 0xffffcc32;
const bit<32> wk_4_3 = 0x0000c38f;
const bit<32> wk_4_4 = 0xffff3e08;
const bit<32> wk_4_5 = 0xffff0b60;
const bit<32> wk_5_3 = 0xffff4168;
const bit<32> wk_5_4 = 0x000021f8;
const bit<32> wk_5_5 = 0x00008a42;
const bit<32> wv_3_3 = 0xffff79e7;
const bit<32> wv_3_4 = 0x00008b75;
const bit<32> wv_3_5 = 0x00004e2b;
const bit<32> wv_4_3 = 0x0000d979;
const bit<32> wv_4_4 = 0x000009b9;
const bit<32> wv_4_5 = 0x0000b6aa;
const bit<32> wv_5_3 = 0xffff8f5e;
const bit<32> wv_5_4 = 0x0000d155;
const bit<32> wv_5_5 = 0x00003eec;
...
control MyIngress(inout headers hdr,
    ...
    action calc_qk(){     
        ...
        bit<16> q_0_3 = (x32_0_3 * wq_3_3 + x32_0_4 * wq_4_3 + x32_0_5 * wq_5_3)[23:8];
        bit<16> q_0_4 = (x32_0_3 * wq_3_4 + x32_0_4 * wq_4_4 + x32_0_5 * wq_5_4)[23:8];
        bit<16> q_0_5 = (x32_0_3 * wq_3_5 + x32_0_4 * wq_4_5 + x32_0_5 * wq_5_5)[23:8];
        bit<16> q_1_3 = (x32_1_3 * wq_3_3 + x32_1_4 * wq_4_3 + x32_1_5 * wq_5_3)[23:8];
        bit<16> q_1_4 = (x32_1_3 * wq_3_4 + x32_1_4 * wq_4_4 + x32_1_5 * wq_5_4)[23:8];
        bit<16> q_1_5 = (x32_1_3 * wq_3_5 + x32_1_4 * wq_4_5 + x32_1_5 * wq_5_5)[23:8];
        bit<16> q_2_3 = (x32_2_3 * wq_3_3 + x32_2_4 * wq_4_3 + x32_2_5 * wq_5_3)[23:8];
        bit<16> q_2_4 = (x32_2_3 * wq_3_4 + x32_2_4 * wq_4_4 + x32_2_5 * wq_5_4)[23:8];
        bit<16> q_2_5 = (x32_2_3 * wq_3_5 + x32_2_4 * wq_4_5 + x32_2_5 * wq_5_5)[23:8];
        bit<16> q_3_3 = (x32_3_3 * wq_3_3 + x32_3_4 * wq_4_3 + x32_3_5 * wq_5_3)[23:8];
        bit<16> q_3_4 = (x32_3_3 * wq_3_4 + x32_3_4 * wq_4_4 + x32_3_5 * wq_5_4)[23:8];
        bit<16> q_3_5 = (x32_3_3 * wq_3_5 + x32_3_4 * wq_4_5 + x32_3_5 * wq_5_5)[23:8];
        bit<16> q_4_3 = (x32_4_3 * wq_3_3 + x32_4_4 * wq_4_3 + x32_4_5 * wq_5_3)[23:8];
        bit<16> q_4_4 = (x32_4_3 * wq_3_4 + x32_4_4 * wq_4_4 + x32_4_5 * wq_5_4)[23:8];
        bit<16> q_4_5 = (x32_4_3 * wq_3_5 + x32_4_4 * wq_4_5 + x32_4_5 * wq_5_5)[23:8];
        bit<16> q_5_3 = (x32_5_3 * wq_3_3 + x32_5_4 * wq_4_3 + x32_5_5 * wq_5_3)[23:8];
        bit<16> q_5_4 = (x32_5_3 * wq_3_4 + x32_5_4 * wq_4_4 + x32_5_5 * wq_5_4)[23:8];
        bit<16> q_5_5 = (x32_5_3 * wq_3_5 + x32_5_4 * wq_4_5 + x32_5_5 * wq_5_5)[23:8];
        bit<16> q_6_3 = (x32_6_3 * wq_3_3 + x32_6_4 * wq_4_3 + x32_6_5 * wq_5_3)[23:8];
        bit<16> q_6_4 = (x32_6_3 * wq_3_4 + x32_6_4 * wq_4_4 + x32_6_5 * wq_5_4)[23:8];
        bit<16> q_6_5 = (x32_6_3 * wq_3_5 + x32_6_4 * wq_4_5 + x32_6_5 * wq_5_5)[23:8];
        bit<16> q_7_3 = (x32_7_3 * wq_3_3 + x32_7_4 * wq_4_3 + x32_7_5 * wq_5_3)[23:8];
        bit<16> q_7_4 = (x32_7_3 * wq_3_4 + x32_7_4 * wq_4_4 + x32_7_5 * wq_5_4)[23:8];
        bit<16> q_7_5 = (x32_7_3 * wq_3_5 + x32_7_4 * wq_4_5 + x32_7_5 * wq_5_5)[23:8];

        // 计算k
        bit<16> k_0_3 = (x32_0_3 * wk_3_3 + x32_0_4 * wk_4_3 + x32_0_5 * wk_5_3)[23:8];
        bit<16> k_0_4 = (x32_0_3 * wk_3_4 + x32_0_4 * wk_4_4 + x32_0_5 * wk_5_4)[23:8];
        bit<16> k_0_5 = (x32_0_3 * wk_3_5 + x32_0_4 * wk_4_5 + x32_0_5 * wk_5_5)[23:8];
        bit<16> k_1_3 = (x32_1_3 * wk_3_3 + x32_1_4 * wk_4_3 + x32_1_5 * wk_5_3)[23:8];
        bit<16> k_1_4 = (x32_1_3 * wk_3_4 + x32_1_4 * wk_4_4 + x32_1_5 * wk_5_4)[23:8];
        bit<16> k_1_5 = (x32_1_3 * wk_3_5 + x32_1_4 * wk_4_5 + x32_1_5 * wk_5_5)[23:8];
        bit<16> k_2_3 = (x32_2_3 * wk_3_3 + x32_2_4 * wk_4_3 + x32_2_5 * wk_5_3)[23:8];
        bit<16> k_2_4 = (x32_2_3 * wk_3_4 + x32_2_4 * wk_4_4 + x32_2_5 * wk_5_4)[23:8];
        bit<16> k_2_5 = (x32_2_3 * wk_3_5 + x32_2_4 * wk_4_5 + x32_2_5 * wk_5_5)[23:8];
        bit<16> k_3_3 = (x32_3_3 * wk_3_3 + x32_3_4 * wk_4_3 + x32_3_5 * wk_5_3)[23:8];
        bit<16> k_3_4 = (x32_3_3 * wk_3_4 + x32_3_4 * wk_4_4 + x32_3_5 * wk_5_4)[23:8];
        bit<16> k_3_5 = (x32_3_3 * wk_3_5 + x32_3_4 * wk_4_5 + x32_3_5 * wk_5_5)[23:8];
        bit<16> k_4_3 = (x32_4_3 * wk_3_3 + x32_4_4 * wk_4_3 + x32_4_5 * wk_5_3)[23:8];
        bit<16> k_4_4 = (x32_4_3 * wk_3_4 + x32_4_4 * wk_4_4 + x32_4_5 * wk_5_4)[23:8];
        bit<16> k_4_5 = (x32_4_3 * wk_3_5 + x32_4_4 * wk_4_5 + x32_4_5 * wk_5_5)[23:8];
        bit<16> k_5_3 = (x32_5_3 * wk_3_3 + x32_5_4 * wk_4_3 + x32_5_5 * wk_5_3)[23:8];
        bit<16> k_5_4 = (x32_5_3 * wk_3_4 + x32_5_4 * wk_4_4 + x32_5_5 * wk_5_4)[23:8];
        bit<16> k_5_5 = (x32_5_3 * wk_3_5 + x32_5_4 * wk_4_5 + x32_5_5 * wk_5_5)[23:8];
        bit<16> k_6_3 = (x32_6_3 * wk_3_3 + x32_6_4 * wk_4_3 + x32_6_5 * wk_5_3)[23:8];
        bit<16> k_6_4 = (x32_6_3 * wk_3_4 + x32_6_4 * wk_4_4 + x32_6_5 * wk_5_4)[23:8];
        bit<16> k_6_5 = (x32_6_3 * wk_3_5 + x32_6_4 * wk_4_5 + x32_6_5 * wk_5_5)[23:8];
        bit<16> k_7_3 = (x32_7_3 * wk_3_3 + x32_7_4 * wk_4_3 + x32_7_5 * wk_5_3)[23:8];
        bit<16> k_7_4 = (x32_7_3 * wk_3_4 + x32_7_4 * wk_4_4 + x32_7_5 * wk_5_4)[23:8];
        bit<16> k_7_5 = (x32_7_3 * wk_3_5 + x32_7_4 * wk_4_5 + x32_7_5 * wk_5_5)[23:8];
        
        // 计算v
        bit<32> v32_0_3 = x32_0_3 * wv_3_3 + x32_0_4 * wv_4_3 + x32_0_5 * wv_5_3;
        bit<32> v32_0_4 = x32_0_3 * wv_3_4 + x32_0_4 * wv_4_4 + x32_0_5 * wv_5_4;
        bit<32> v32_0_5 = x32_0_3 * wv_3_5 + x32_0_4 * wv_4_5 + x32_0_5 * wv_5_5;
        bit<32> v32_1_3 = x32_1_3 * wv_3_3 + x32_1_4 * wv_4_3 + x32_1_5 * wv_5_3;
        bit<32> v32_1_4 = x32_1_3 * wv_3_4 + x32_1_4 * wv_4_4 + x32_1_5 * wv_5_4;
        bit<32> v32_1_5 = x32_1_3 * wv_3_5 + x32_1_4 * wv_4_5 + x32_1_5 * wv_5_5;
        bit<32> v32_2_3 = x32_2_3 * wv_3_3 + x32_2_4 * wv_4_3 + x32_2_5 * wv_5_3;
        bit<32> v32_2_4 = x32_2_3 * wv_3_4 + x32_2_4 * wv_4_4 + x32_2_5 * wv_5_4;
        bit<32> v32_2_5 = x32_2_3 * wv_3_5 + x32_2_4 * wv_4_5 + x32_2_5 * wv_5_5;
        bit<32> v32_3_3 = x32_3_3 * wv_3_3 + x32_3_4 * wv_4_3 + x32_3_5 * wv_5_3;
        bit<32> v32_3_4 = x32_3_3 * wv_3_4 + x32_3_4 * wv_4_4 + x32_3_5 * wv_5_4;
        bit<32> v32_3_5 = x32_3_3 * wv_3_5 + x32_3_4 * wv_4_5 + x32_3_5 * wv_5_5;
        bit<32> v32_4_3 = x32_4_3 * wv_3_3 + x32_4_4 * wv_4_3 + x32_4_5 * wv_5_3;
        bit<32> v32_4_4 = x32_4_3 * wv_3_4 + x32_4_4 * wv_4_4 + x32_4_5 * wv_5_4;
        bit<32> v32_4_5 = x32_4_3 * wv_3_5 + x32_4_4 * wv_4_5 + x32_4_5 * wv_5_5;
        bit<32> v32_5_3 = x32_5_3 * wv_3_3 + x32_5_4 * wv_4_3 + x32_5_5 * wv_5_3;
        bit<32> v32_5_4 = x32_5_3 * wv_3_4 + x32_5_4 * wv_4_4 + x32_5_5 * wv_5_4;
        bit<32> v32_5_5 = x32_5_3 * wv_3_5 + x32_5_4 * wv_4_5 + x32_5_5 * wv_5_5;
        bit<32> v32_6_3 = x32_6_3 * wv_3_3 + x32_6_4 * wv_4_3 + x32_6_5 * wv_5_3;
        bit<32> v32_6_4 = x32_6_3 * wv_3_4 + x32_6_4 * wv_4_4 + x32_6_5 * wv_5_4;
        bit<32> v32_6_5 = x32_6_3 * wv_3_5 + x32_6_4 * wv_4_5 + x32_6_5 * wv_5_5;
        bit<32> v32_7_3 = x32_7_3 * wv_3_3 + x32_7_4 * wv_4_3 + x32_7_5 * wv_5_3;
        bit<32> v32_7_4 = x32_7_3 * wv_3_4 + x32_7_4 * wv_4_4 + x32_7_5 * wv_5_4;
        bit<32> v32_7_5 = x32_7_3 * wv_3_5 + x32_7_4 * wv_4_5 + x32_7_5 * wv_5_5;
