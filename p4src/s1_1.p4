...
const bit<32> wq_3_3 = 0x4762e07f;
const bit<32> wq_3_4 = 0xd8643a16;
const bit<32> wq_3_5 = 0x5cb96c69;
const bit<32> wq_4_3 = 0xf9c8c95f;
const bit<32> wq_4_4 = 0x6d62ca8c;
const bit<32> wq_4_5 = 0x60cdcf18;
const bit<32> wq_5_3 = 0x52a30dc7;
const bit<32> wq_5_4 = 0x62c06b3;
const bit<32> wq_5_5 = 0x307e6a6e;

const bit<32> wk_3_3 = 0x5b697207;
const bit<32> wk_3_4 = 0xb11eab1c;
const bit<32> wk_3_5 = 0xd9e29730;
const bit<32> wk_4_3 = 0x454f9af3;
const bit<32> wk_4_4 = 0xbcd13fa3;
const bit<32> wk_4_5 = 0xa6e02a84;
const bit<32> wk_5_3 = 0x867ebfc8;
const bit<32> wk_5_4 = 0xa666ae3c;
const bit<32> wk_5_5 = 0xdaad9280;

const bit<32> wv_3_3 = 0x9964546f;
const bit<32> wv_3_4 = 0xa050299f;
const bit<32> wv_3_5 = 0xa4ff3e8f;
const bit<32> wv_4_3 = 0x14fe80e8;
const bit<32> wv_4_4 = 0x531ff9cd;
const bit<32> wv_4_5 = 0x2a6deb77;
const bit<32> wv_5_3 = 0xe68b01ca;
const bit<32> wv_5_4 = 0x491aa9c0;
const bit<32> wv_5_5 = 0xc918caa0;
...
control MyIngress(inout headers hdr,
    ...
    action calc_qk(){     
        ...
        //计算q
        bit<32> q_0_3 = x_0_3 * wq_3_3 + x_0_4 * wq_4_3 + x_0_5 * wq_5_3;
        bit<32> q_0_4 = x_0_3 * wq_3_4 + x_0_4 * wq_4_4 + x_0_5 * wq_5_4;
        bit<32> q_0_5 = x_0_3 * wq_3_5 + x_0_4 * wq_4_5 + x_0_5 * wq_5_5;
        bit<32> q_1_3 = x_1_3 * wq_3_3 + x_1_4 * wq_4_3 + x_1_5 * wq_5_3;
        bit<32> q_1_4 = x_1_3 * wq_3_4 + x_1_4 * wq_4_4 + x_1_5 * wq_5_4;
        bit<32> q_1_5 = x_1_3 * wq_3_5 + x_1_4 * wq_4_5 + x_1_5 * wq_5_5;
        bit<32> q_2_3 = x_2_3 * wq_3_3 + x_2_4 * wq_4_3 + x_2_5 * wq_5_3;
        bit<32> q_2_4 = x_2_3 * wq_3_4 + x_2_4 * wq_4_4 + x_2_5 * wq_5_4;
        bit<32> q_2_5 = x_2_3 * wq_3_5 + x_2_4 * wq_4_5 + x_2_5 * wq_5_5;
        bit<32> q_3_3 = x_3_3 * wq_3_3 + x_3_4 * wq_4_3 + x_3_5 * wq_5_3;
        bit<32> q_3_4 = x_3_3 * wq_3_4 + x_3_4 * wq_4_4 + x_3_5 * wq_5_4;
        bit<32> q_3_5 = x_3_3 * wq_3_5 + x_3_4 * wq_4_5 + x_3_5 * wq_5_5;
        bit<32> q_4_3 = x_4_3 * wq_3_3 + x_4_4 * wq_4_3 + x_4_5 * wq_5_3;
        bit<32> q_4_4 = x_4_3 * wq_3_4 + x_4_4 * wq_4_4 + x_4_5 * wq_5_4;
        bit<32> q_4_5 = x_4_3 * wq_3_5 + x_4_4 * wq_4_5 + x_4_5 * wq_5_5;
        bit<32> q_5_3 = x_5_3 * wq_3_3 + x_5_4 * wq_4_3 + x_5_5 * wq_5_3;
        bit<32> q_5_4 = x_5_3 * wq_3_4 + x_5_4 * wq_4_4 + x_5_5 * wq_5_4;
        bit<32> q_5_5 = x_5_3 * wq_3_5 + x_5_4 * wq_4_5 + x_5_5 * wq_5_5;
        bit<32> q_6_3 = x_6_3 * wq_3_3 + x_6_4 * wq_4_3 + x_6_5 * wq_5_3;
        bit<32> q_6_4 = x_6_3 * wq_3_4 + x_6_4 * wq_4_4 + x_6_5 * wq_5_4;
        bit<32> q_6_5 = x_6_3 * wq_3_5 + x_6_4 * wq_4_5 + x_6_5 * wq_5_5;
        bit<32> q_7_3 = x_7_3 * wq_3_3 + x_7_4 * wq_4_3 + x_7_5 * wq_5_3;
        bit<32> q_7_4 = x_7_3 * wq_3_4 + x_7_4 * wq_4_4 + x_7_5 * wq_5_4;
        bit<32> q_7_5 = x_7_3 * wq_3_5 + x_7_4 * wq_4_5 + x_7_5 * wq_5_5;

        // 计算k
        bit<32> k_0_3 = x_0_3 * wq_3_3 + x_0_4 * wq_4_3 + x_0_5 * wq_5_3;
        bit<32> k_0_4 = x_0_3 * wq_3_4 + x_0_4 * wq_4_4 + x_0_5 * wq_5_4;
        bit<32> k_0_5 = x_0_3 * wq_3_5 + x_0_4 * wq_4_5 + x_0_5 * wq_5_5;
        bit<32> k_1_3 = x_1_3 * wq_3_3 + x_1_4 * wq_4_3 + x_1_5 * wq_5_3;
        bit<32> k_1_4 = x_1_3 * wq_3_4 + x_1_4 * wq_4_4 + x_1_5 * wq_5_4;
        bit<32> k_1_5 = x_1_3 * wq_3_5 + x_1_4 * wq_4_5 + x_1_5 * wq_5_5;
        bit<32> k_2_3 = x_2_3 * wq_3_3 + x_2_4 * wq_4_3 + x_2_5 * wq_5_3;
        bit<32> k_2_4 = x_2_3 * wq_3_4 + x_2_4 * wq_4_4 + x_2_5 * wq_5_4;
        bit<32> k_2_5 = x_2_3 * wq_3_5 + x_2_4 * wq_4_5 + x_2_5 * wq_5_5;
        bit<32> k_3_3 = x_3_3 * wq_3_3 + x_3_4 * wq_4_3 + x_3_5 * wq_5_3;
        bit<32> k_3_4 = x_3_3 * wq_3_4 + x_3_4 * wq_4_4 + x_3_5 * wq_5_4;
        bit<32> k_3_5 = x_3_3 * wq_3_5 + x_3_4 * wq_4_5 + x_3_5 * wq_5_5;
        bit<32> k_4_3 = x_4_3 * wq_3_3 + x_4_4 * wq_4_3 + x_4_5 * wq_5_3;
        bit<32> k_4_4 = x_4_3 * wq_3_4 + x_4_4 * wq_4_4 + x_4_5 * wq_5_4;
        bit<32> k_4_5 = x_4_3 * wq_3_5 + x_4_4 * wq_4_5 + x_4_5 * wq_5_5;
        bit<32> k_5_3 = x_5_3 * wq_3_3 + x_5_4 * wq_4_3 + x_5_5 * wq_5_3;
        bit<32> k_5_4 = x_5_3 * wq_3_4 + x_5_4 * wq_4_4 + x_5_5 * wq_5_4;
        bit<32> k_5_5 = x_5_3 * wq_3_5 + x_5_4 * wq_4_5 + x_5_5 * wq_5_5;
        bit<32> k_6_3 = x_6_3 * wq_3_3 + x_6_4 * wq_4_3 + x_6_5 * wq_5_3;
        bit<32> k_6_4 = x_6_3 * wq_3_4 + x_6_4 * wq_4_4 + x_6_5 * wq_5_4;
        bit<32> k_6_5 = x_6_3 * wq_3_5 + x_6_4 * wq_4_5 + x_6_5 * wq_5_5;
        bit<32> k_7_3 = x_7_3 * wq_3_3 + x_7_4 * wq_4_3 + x_7_5 * wq_5_3;
        bit<32> k_7_4 = x_7_3 * wq_3_4 + x_7_4 * wq_4_4 + x_7_5 * wq_5_4;
        bit<32> k_7_5 = x_7_3 * wq_3_5 + x_7_4 * wq_4_5 + x_7_5 * wq_5_5;
        
        // 计算v
        meta.v_0_3 = x_0_3 * wq_3_3 + x_0_4 * wq_4_3 + x_0_5 * wq_5_3;
        meta.v_0_4 = x_0_3 * wq_3_4 + x_0_4 * wq_4_4 + x_0_5 * wq_5_4;
        meta.v_0_5 = x_0_3 * wq_3_5 + x_0_4 * wq_4_5 + x_0_5 * wq_5_5;
        meta.v_1_3 = x_1_3 * wq_3_3 + x_1_4 * wq_4_3 + x_1_5 * wq_5_3;
        meta.v_1_4 = x_1_3 * wq_3_4 + x_1_4 * wq_4_4 + x_1_5 * wq_5_4;
        meta.v_1_5 = x_1_3 * wq_3_5 + x_1_4 * wq_4_5 + x_1_5 * wq_5_5;
        meta.v_2_3 = x_2_3 * wq_3_3 + x_2_4 * wq_4_3 + x_2_5 * wq_5_3;
        meta.v_2_4 = x_2_3 * wq_3_4 + x_2_4 * wq_4_4 + x_2_5 * wq_5_4;
        meta.v_2_5 = x_2_3 * wq_3_5 + x_2_4 * wq_4_5 + x_2_5 * wq_5_5;
        meta.v_3_3 = x_3_3 * wq_3_3 + x_3_4 * wq_4_3 + x_3_5 * wq_5_3;
        meta.v_3_4 = x_3_3 * wq_3_4 + x_3_4 * wq_4_4 + x_3_5 * wq_5_4;
        meta.v_3_5 = x_3_3 * wq_3_5 + x_3_4 * wq_4_5 + x_3_5 * wq_5_5;
        meta.v_4_3 = x_4_3 * wq_3_3 + x_4_4 * wq_4_3 + x_4_5 * wq_5_3;
        meta.v_4_4 = x_4_3 * wq_3_4 + x_4_4 * wq_4_4 + x_4_5 * wq_5_4;
        meta.v_4_5 = x_4_3 * wq_3_5 + x_4_4 * wq_4_5 + x_4_5 * wq_5_5;
        meta.v_5_3 = x_5_3 * wq_3_3 + x_5_4 * wq_4_3 + x_5_5 * wq_5_3;
        meta.v_5_4 = x_5_3 * wq_3_4 + x_5_4 * wq_4_4 + x_5_5 * wq_5_4;
        meta.v_5_5 = x_5_3 * wq_3_5 + x_5_4 * wq_4_5 + x_5_5 * wq_5_5;
        meta.v_6_3 = x_6_3 * wq_3_3 + x_6_4 * wq_4_3 + x_6_5 * wq_5_3;
        meta.v_6_4 = x_6_3 * wq_3_4 + x_6_4 * wq_4_4 + x_6_5 * wq_5_4;
        meta.v_6_5 = x_6_3 * wq_3_5 + x_6_4 * wq_4_5 + x_6_5 * wq_5_5;
        meta.v_7_3 = x_7_3 * wq_3_3 + x_7_4 * wq_4_3 + x_7_5 * wq_5_3;
        meta.v_7_4 = x_7_3 * wq_3_4 + x_7_4 * wq_4_4 + x_7_5 * wq_5_4;
        meta.v_7_5 = x_7_3 * wq_3_5 + x_7_4 * wq_4_5 + x_7_5 * wq_5_5;

        // 计算q*k_t
        bit<32> q_mul_kt_0_0 = q_0_3 * k_0_3 + q_0_4 * k_0_4 + q_0_5 * k_0_5 ;
        bit<32> q_mul_kt_0_1 = q_0_3 * k_1_3 + q_0_4 * k_1_4 + q_0_5 * k_1_5 ;
        bit<32> q_mul_kt_0_2 = q_0_3 * k_2_3 + q_0_4 * k_2_4 + q_0_5 * k_2_5 ;
        bit<32> q_mul_kt_0_3 = q_0_3 * k_3_3 + q_0_4 * k_3_4 + q_0_5 * k_3_5 ;
        bit<32> q_mul_kt_0_4 = q_0_3 * k_4_3 + q_0_4 * k_4_4 + q_0_5 * k_4_5 ;
        bit<32> q_mul_kt_0_5 = q_0_3 * k_5_3 + q_0_4 * k_5_4 + q_0_5 * k_5_5 ;
        bit<32> q_mul_kt_0_6 = q_0_3 * k_6_3 + q_0_4 * k_6_4 + q_0_5 * k_6_5 ;
        bit<32> q_mul_kt_0_7 = q_0_3 * k_7_3 + q_0_4 * k_7_4 + q_0_5 * k_7_5 ;
        bit<32> q_mul_kt_1_0 = q_1_3 * k_0_3 + q_1_4 * k_0_4 + q_1_5 * k_0_5 ;
        bit<32> q_mul_kt_1_1 = q_1_3 * k_1_3 + q_1_4 * k_1_4 + q_1_5 * k_1_5 ;
        bit<32> q_mul_kt_1_2 = q_1_3 * k_2_3 + q_1_4 * k_2_4 + q_1_5 * k_2_5 ;
        bit<32> q_mul_kt_1_3 = q_1_3 * k_3_3 + q_1_4 * k_3_4 + q_1_5 * k_3_5 ;
        bit<32> q_mul_kt_1_4 = q_1_3 * k_4_3 + q_1_4 * k_4_4 + q_1_5 * k_4_5 ;
        bit<32> q_mul_kt_1_5 = q_1_3 * k_5_3 + q_1_4 * k_5_4 + q_1_5 * k_5_5 ;
        bit<32> q_mul_kt_1_6 = q_1_3 * k_6_3 + q_1_4 * k_6_4 + q_1_5 * k_6_5 ;
        bit<32> q_mul_kt_1_7 = q_1_3 * k_7_3 + q_1_4 * k_7_4 + q_1_5 * k_7_5 ;
        bit<32> q_mul_kt_2_0 = q_2_3 * k_0_3 + q_2_4 * k_0_4 + q_2_5 * k_0_5 ;
        bit<32> q_mul_kt_2_1 = q_2_3 * k_1_3 + q_2_4 * k_1_4 + q_2_5 * k_1_5 ;
        bit<32> q_mul_kt_2_2 = q_2_3 * k_2_3 + q_2_4 * k_2_4 + q_2_5 * k_2_5 ;
        bit<32> q_mul_kt_2_3 = q_2_3 * k_3_3 + q_2_4 * k_3_4 + q_2_5 * k_3_5 ;
        bit<32> q_mul_kt_2_4 = q_2_3 * k_4_3 + q_2_4 * k_4_4 + q_2_5 * k_4_5 ;
        bit<32> q_mul_kt_2_5 = q_2_3 * k_5_3 + q_2_4 * k_5_4 + q_2_5 * k_5_5 ;
        bit<32> q_mul_kt_2_6 = q_2_3 * k_6_3 + q_2_4 * k_6_4 + q_2_5 * k_6_5 ;
        bit<32> q_mul_kt_2_7 = q_2_3 * k_7_3 + q_2_4 * k_7_4 + q_2_5 * k_7_5 ;
        bit<32> q_mul_kt_3_0 = q_3_3 * k_0_3 + q_3_4 * k_0_4 + q_3_5 * k_0_5 ;
        bit<32> q_mul_kt_3_1 = q_3_3 * k_1_3 + q_3_4 * k_1_4 + q_3_5 * k_1_5 ;
        bit<32> q_mul_kt_3_2 = q_3_3 * k_2_3 + q_3_4 * k_2_4 + q_3_5 * k_2_5 ;
        bit<32> q_mul_kt_3_3 = q_3_3 * k_3_3 + q_3_4 * k_3_4 + q_3_5 * k_3_5 ;
        bit<32> q_mul_kt_3_4 = q_3_3 * k_4_3 + q_3_4 * k_4_4 + q_3_5 * k_4_5 ;
        bit<32> q_mul_kt_3_5 = q_3_3 * k_5_3 + q_3_4 * k_5_4 + q_3_5 * k_5_5 ;
        bit<32> q_mul_kt_3_6 = q_3_3 * k_6_3 + q_3_4 * k_6_4 + q_3_5 * k_6_5 ;
        bit<32> q_mul_kt_3_7 = q_3_3 * k_7_3 + q_3_4 * k_7_4 + q_3_5 * k_7_5 ;
        bit<32> q_mul_kt_4_0 = q_4_3 * k_0_3 + q_4_4 * k_0_4 + q_4_5 * k_0_5 ;
        bit<32> q_mul_kt_4_1 = q_4_3 * k_1_3 + q_4_4 * k_1_4 + q_4_5 * k_1_5 ;
        bit<32> q_mul_kt_4_2 = q_4_3 * k_2_3 + q_4_4 * k_2_4 + q_4_5 * k_2_5 ;
        bit<32> q_mul_kt_4_3 = q_4_3 * k_3_3 + q_4_4 * k_3_4 + q_4_5 * k_3_5 ;
        bit<32> q_mul_kt_4_4 = q_4_3 * k_4_3 + q_4_4 * k_4_4 + q_4_5 * k_4_5 ;
        bit<32> q_mul_kt_4_5 = q_4_3 * k_5_3 + q_4_4 * k_5_4 + q_4_5 * k_5_5 ;
        bit<32> q_mul_kt_4_6 = q_4_3 * k_6_3 + q_4_4 * k_6_4 + q_4_5 * k_6_5 ;
        bit<32> q_mul_kt_4_7 = q_4_3 * k_7_3 + q_4_4 * k_7_4 + q_4_5 * k_7_5 ;
        bit<32> q_mul_kt_5_0 = q_5_3 * k_0_3 + q_5_4 * k_0_4 + q_5_5 * k_0_5 ;
        bit<32> q_mul_kt_5_1 = q_5_3 * k_1_3 + q_5_4 * k_1_4 + q_5_5 * k_1_5 ;
        bit<32> q_mul_kt_5_2 = q_5_3 * k_2_3 + q_5_4 * k_2_4 + q_5_5 * k_2_5 ;
        bit<32> q_mul_kt_5_3 = q_5_3 * k_3_3 + q_5_4 * k_3_4 + q_5_5 * k_3_5 ;
        bit<32> q_mul_kt_5_4 = q_5_3 * k_4_3 + q_5_4 * k_4_4 + q_5_5 * k_4_5 ;
        bit<32> q_mul_kt_5_5 = q_5_3 * k_5_3 + q_5_4 * k_5_4 + q_5_5 * k_5_5 ;
        bit<32> q_mul_kt_5_6 = q_5_3 * k_6_3 + q_5_4 * k_6_4 + q_5_5 * k_6_5 ;
        bit<32> q_mul_kt_5_7 = q_5_3 * k_7_3 + q_5_4 * k_7_4 + q_5_5 * k_7_5 ;
        bit<32> q_mul_kt_6_0 = q_6_3 * k_0_3 + q_6_4 * k_0_4 + q_6_5 * k_0_5 ;
        bit<32> q_mul_kt_6_1 = q_6_3 * k_1_3 + q_6_4 * k_1_4 + q_6_5 * k_1_5 ;
        bit<32> q_mul_kt_6_2 = q_6_3 * k_2_3 + q_6_4 * k_2_4 + q_6_5 * k_2_5 ;
        bit<32> q_mul_kt_6_3 = q_6_3 * k_3_3 + q_6_4 * k_3_4 + q_6_5 * k_3_5 ;
        bit<32> q_mul_kt_6_4 = q_6_3 * k_4_3 + q_6_4 * k_4_4 + q_6_5 * k_4_5 ;
        bit<32> q_mul_kt_6_5 = q_6_3 * k_5_3 + q_6_4 * k_5_4 + q_6_5 * k_5_5 ;
        bit<32> q_mul_kt_6_6 = q_6_3 * k_6_3 + q_6_4 * k_6_4 + q_6_5 * k_6_5 ;
        bit<32> q_mul_kt_6_7 = q_6_3 * k_7_3 + q_6_4 * k_7_4 + q_6_5 * k_7_5 ;
        bit<32> q_mul_kt_7_0 = q_7_3 * k_0_3 + q_7_4 * k_0_4 + q_7_5 * k_0_5 ;
        bit<32> q_mul_kt_7_1 = q_7_3 * k_1_3 + q_7_4 * k_1_4 + q_7_5 * k_1_5 ;
        bit<32> q_mul_kt_7_2 = q_7_3 * k_2_3 + q_7_4 * k_2_4 + q_7_5 * k_2_5 ;
        bit<32> q_mul_kt_7_3 = q_7_3 * k_3_3 + q_7_4 * k_3_4 + q_7_5 * k_3_5 ;
        bit<32> q_mul_kt_7_4 = q_7_3 * k_4_3 + q_7_4 * k_4_4 + q_7_5 * k_4_5 ;
        bit<32> q_mul_kt_7_5 = q_7_3 * k_5_3 + q_7_4 * k_5_4 + q_7_5 * k_5_5 ;
        bit<32> q_mul_kt_7_6 = q_7_3 * k_6_3 + q_7_4 * k_6_4 + q_7_5 * k_6_5 ;
        bit<32> q_mul_kt_7_7 = q_7_3 * k_7_3 + q_7_4 * k_7_4 + q_7_5 * k_7_5 ;
    ...
    action cal_mul_v() {
        ...
        hdr.s1_output0_calc.s1_output_0_3 = softmax_0_0 * meta.v_0_3 + softmax_0_1 * meta.v_1_3 + softmax_0_2 * meta.v_2_3 + softmax_0_3 * meta.v_3_3 + softmax_0_4 * meta.v_4_3 + softmax_0_5 * meta.v_5_3 + softmax_0_6 * meta.v_6_3 + softmax_0_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_0_4 = softmax_0_0 * meta.v_0_4 + softmax_0_1 * meta.v_1_4 + softmax_0_2 * meta.v_2_4 + softmax_0_3 * meta.v_3_4 + softmax_0_4 * meta.v_4_4 + softmax_0_5 * meta.v_5_4 + softmax_0_6 * meta.v_6_4 + softmax_0_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_0_5 = softmax_0_0 * meta.v_0_5 + softmax_0_1 * meta.v_1_5 + softmax_0_2 * meta.v_2_5 + softmax_0_3 * meta.v_3_5 + softmax_0_4 * meta.v_4_5 + softmax_0_5 * meta.v_5_5 + softmax_0_6 * meta.v_6_5 + softmax_0_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_1_3 = softmax_1_0 * meta.v_0_3 + softmax_1_1 * meta.v_1_3 + softmax_1_2 * meta.v_2_3 + softmax_1_3 * meta.v_3_3 + softmax_1_4 * meta.v_4_3 + softmax_1_5 * meta.v_5_3 + softmax_1_6 * meta.v_6_3 + softmax_1_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_1_4 = softmax_1_0 * meta.v_0_4 + softmax_1_1 * meta.v_1_4 + softmax_1_2 * meta.v_2_4 + softmax_1_3 * meta.v_3_4 + softmax_1_4 * meta.v_4_4 + softmax_1_5 * meta.v_5_4 + softmax_1_6 * meta.v_6_4 + softmax_1_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_1_5 = softmax_1_0 * meta.v_0_5 + softmax_1_1 * meta.v_1_5 + softmax_1_2 * meta.v_2_5 + softmax_1_3 * meta.v_3_5 + softmax_1_4 * meta.v_4_5 + softmax_1_5 * meta.v_5_5 + softmax_1_6 * meta.v_6_5 + softmax_1_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_2_3 = softmax_2_0 * meta.v_0_3 + softmax_2_1 * meta.v_1_3 + softmax_2_2 * meta.v_2_3 + softmax_2_3 * meta.v_3_3 + softmax_2_4 * meta.v_4_3 + softmax_2_5 * meta.v_5_3 + softmax_2_6 * meta.v_6_3 + softmax_2_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_2_4 = softmax_2_0 * meta.v_0_4 + softmax_2_1 * meta.v_1_4 + softmax_2_2 * meta.v_2_4 + softmax_2_3 * meta.v_3_4 + softmax_2_4 * meta.v_4_4 + softmax_2_5 * meta.v_5_4 + softmax_2_6 * meta.v_6_4 + softmax_2_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_2_5 = softmax_2_0 * meta.v_0_5 + softmax_2_1 * meta.v_1_5 + softmax_2_2 * meta.v_2_5 + softmax_2_3 * meta.v_3_5 + softmax_2_4 * meta.v_4_5 + softmax_2_5 * meta.v_5_5 + softmax_2_6 * meta.v_6_5 + softmax_2_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_3_3 = softmax_3_0 * meta.v_0_3 + softmax_3_1 * meta.v_1_3 + softmax_3_2 * meta.v_2_3 + softmax_3_3 * meta.v_3_3 + softmax_3_4 * meta.v_4_3 + softmax_3_5 * meta.v_5_3 + softmax_3_6 * meta.v_6_3 + softmax_3_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_3_4 = softmax_3_0 * meta.v_0_4 + softmax_3_1 * meta.v_1_4 + softmax_3_2 * meta.v_2_4 + softmax_3_3 * meta.v_3_4 + softmax_3_4 * meta.v_4_4 + softmax_3_5 * meta.v_5_4 + softmax_3_6 * meta.v_6_4 + softmax_3_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_3_5 = softmax_3_0 * meta.v_0_5 + softmax_3_1 * meta.v_1_5 + softmax_3_2 * meta.v_2_5 + softmax_3_3 * meta.v_3_5 + softmax_3_4 * meta.v_4_5 + softmax_3_5 * meta.v_5_5 + softmax_3_6 * meta.v_6_5 + softmax_3_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_4_3 = softmax_4_0 * meta.v_0_3 + softmax_4_1 * meta.v_1_3 + softmax_4_2 * meta.v_2_3 + softmax_4_3 * meta.v_3_3 + softmax_4_4 * meta.v_4_3 + softmax_4_5 * meta.v_5_3 + softmax_4_6 * meta.v_6_3 + softmax_4_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_4_4 = softmax_4_0 * meta.v_0_4 + softmax_4_1 * meta.v_1_4 + softmax_4_2 * meta.v_2_4 + softmax_4_3 * meta.v_3_4 + softmax_4_4 * meta.v_4_4 + softmax_4_5 * meta.v_5_4 + softmax_4_6 * meta.v_6_4 + softmax_4_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_4_5 = softmax_4_0 * meta.v_0_5 + softmax_4_1 * meta.v_1_5 + softmax_4_2 * meta.v_2_5 + softmax_4_3 * meta.v_3_5 + softmax_4_4 * meta.v_4_5 + softmax_4_5 * meta.v_5_5 + softmax_4_6 * meta.v_6_5 + softmax_4_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_5_3 = softmax_5_0 * meta.v_0_3 + softmax_5_1 * meta.v_1_3 + softmax_5_2 * meta.v_2_3 + softmax_5_3 * meta.v_3_3 + softmax_5_4 * meta.v_4_3 + softmax_5_5 * meta.v_5_3 + softmax_5_6 * meta.v_6_3 + softmax_5_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_5_4 = softmax_5_0 * meta.v_0_4 + softmax_5_1 * meta.v_1_4 + softmax_5_2 * meta.v_2_4 + softmax_5_3 * meta.v_3_4 + softmax_5_4 * meta.v_4_4 + softmax_5_5 * meta.v_5_4 + softmax_5_6 * meta.v_6_4 + softmax_5_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_5_5 = softmax_5_0 * meta.v_0_5 + softmax_5_1 * meta.v_1_5 + softmax_5_2 * meta.v_2_5 + softmax_5_3 * meta.v_3_5 + softmax_5_4 * meta.v_4_5 + softmax_5_5 * meta.v_5_5 + softmax_5_6 * meta.v_6_5 + softmax_5_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_6_3 = softmax_6_0 * meta.v_0_3 + softmax_6_1 * meta.v_1_3 + softmax_6_2 * meta.v_2_3 + softmax_6_3 * meta.v_3_3 + softmax_6_4 * meta.v_4_3 + softmax_6_5 * meta.v_5_3 + softmax_6_6 * meta.v_6_3 + softmax_6_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_6_4 = softmax_6_0 * meta.v_0_4 + softmax_6_1 * meta.v_1_4 + softmax_6_2 * meta.v_2_4 + softmax_6_3 * meta.v_3_4 + softmax_6_4 * meta.v_4_4 + softmax_6_5 * meta.v_5_4 + softmax_6_6 * meta.v_6_4 + softmax_6_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_6_5 = softmax_6_0 * meta.v_0_5 + softmax_6_1 * meta.v_1_5 + softmax_6_2 * meta.v_2_5 + softmax_6_3 * meta.v_3_5 + softmax_6_4 * meta.v_4_5 + softmax_6_5 * meta.v_5_5 + softmax_6_6 * meta.v_6_5 + softmax_6_7 * meta.v_7_5;
        hdr.s1_output0_calc.s1_output_7_3 = softmax_7_0 * meta.v_0_3 + softmax_7_1 * meta.v_1_3 + softmax_7_2 * meta.v_2_3 + softmax_7_3 * meta.v_3_3 + softmax_7_4 * meta.v_4_3 + softmax_7_5 * meta.v_5_3 + softmax_7_6 * meta.v_6_3 + softmax_7_7 * meta.v_7_3;
        hdr.s1_output0_calc.s1_output_7_4 = softmax_7_0 * meta.v_0_4 + softmax_7_1 * meta.v_1_4 + softmax_7_2 * meta.v_2_4 + softmax_7_3 * meta.v_3_4 + softmax_7_4 * meta.v_4_4 + softmax_7_5 * meta.v_5_4 + softmax_7_6 * meta.v_6_4 + softmax_7_7 * meta.v_7_4;
        hdr.s1_output0_calc.s1_output_7_5 = softmax_7_0 * meta.v_0_5 + softmax_7_1 * meta.v_1_5 + softmax_7_2 * meta.v_2_5 + softmax_7_3 * meta.v_3_5 + softmax_7_4 * meta.v_4_5 + softmax_7_5 * meta.v_5_5 + softmax_7_6 * meta.v_6_5 + softmax_7_7 * meta.v_7_5;
