...
const bit<32> wq_0_3 = 0xffffe7d2;
const bit<32> wq_0_4 = 0x00002221;
const bit<32> wq_0_5 = 0x00002871;
const bit<32> wq_1_3 = 0xffffd6a7;
const bit<32> wq_1_4 = 0xffff8f45;
const bit<32> wq_1_5 = 0xffffec0e;
const bit<32> wq_2_3 = 0xffffdaef;
const bit<32> wq_2_4 = 0xffffb949;
const bit<32> wq_2_5 = 0xffffbf53;
const bit<32> wq_3_3 = 0xffff8e9d;
const bit<32> wq_3_4 = 0xfffff479;
const bit<32> wq_3_5 = 0x0000574a;
const bit<32> wq_4_3 = 0xffff9004;
const bit<32> wq_4_4 = 0xffffc2e0;
const bit<32> wq_4_5 = 0x00001642;
const bit<32> wq_5_3 = 0xfffff06e;
const bit<32> wq_5_4 = 0xffff9113;
const bit<32> wq_5_5 = 0xffffd846;
const bit<32> wk_0_3 = 0xffffe7a9;
const bit<32> wk_0_4 = 0x0000172e;
const bit<32> wk_0_5 = 0xfffffb89;
const bit<32> wk_1_3 = 0xfffffe36;
const bit<32> wk_1_4 = 0x00005313;
const bit<32> wk_1_5 = 0x00000581;
const bit<32> wk_2_3 = 0xffffa571;
const bit<32> wk_2_4 = 0x00001e08;
const bit<32> wk_2_5 = 0xffff8bd9;
const bit<32> wk_3_3 = 0x00001de4;
const bit<32> wk_3_4 = 0xffffb1bf;
const bit<32> wk_3_5 = 0x00002ad1;
const bit<32> wk_4_3 = 0xffff8252;
const bit<32> wk_4_4 = 0xffffc934;
const bit<32> wk_4_5 = 0x00003fbb;
const bit<32> wk_5_3 = 0xfffffdee;
const bit<32> wk_5_4 = 0x00007592;
const bit<32> wk_5_5 = 0x000011cb;
const bit<32> wv_0_3 = 0x00007d71;
const bit<32> wv_0_4 = 0x00001901;
const bit<32> wv_0_5 = 0xffffbcb8;
const bit<32> wv_1_3 = 0xffffb474;
const bit<32> wv_1_4 = 0xfffff1e8;
const bit<32> wv_1_5 = 0xffffc26d;
const bit<32> wv_2_3 = 0x0000385d;
const bit<32> wv_2_4 = 0xffffa789;
const bit<32> wv_2_5 = 0x00005a2e;
const bit<32> wv_3_3 = 0xffffd1a6;
const bit<32> wv_3_4 = 0xffffa1c4;
const bit<32> wv_3_5 = 0xffff971e;
const bit<32> wv_4_3 = 0xffffce8e;
const bit<32> wv_4_4 = 0x000005ef;
const bit<32> wv_4_5 = 0xffff804d;
const bit<32> wv_5_3 = 0xffffa8d2;
const bit<32> wv_5_4 = 0x000036e9;
const bit<32> wv_5_5 = 0xfffffc2a;
...
control MyIngress(inout headers hdr,
    ...
    action calc_qk(){     
        ...
        bit<16> q_0_3 = (x32_0_0 * wq_0_3 + x32_0_1 * wq_1_3 + x32_0_2 * wq_2_3 + x32_0_3 * wq_3_3 + x32_0_4 * wq_4_3 + x32_0_5 * wq_5_3)[23:8];
        bit<16> q_0_4 = (x32_0_0 * wq_0_4 + x32_0_1 * wq_1_4 + x32_0_2 * wq_2_4 + x32_0_3 * wq_3_4 + x32_0_4 * wq_4_4 + x32_0_5 * wq_5_4)[23:8];
        bit<16> q_0_5 = (x32_0_0 * wq_0_5 + x32_0_1 * wq_1_5 + x32_0_2 * wq_2_5 + x32_0_3 * wq_3_5 + x32_0_4 * wq_4_5 + x32_0_5 * wq_5_5)[23:8];
        bit<16> q_1_3 = (x32_1_0 * wq_0_3 + x32_1_1 * wq_1_3 + x32_1_2 * wq_2_3 + x32_1_3 * wq_3_3 + x32_1_4 * wq_4_3 + x32_1_5 * wq_5_3)[23:8];
        bit<16> q_1_4 = (x32_1_0 * wq_0_4 + x32_1_1 * wq_1_4 + x32_1_2 * wq_2_4 + x32_1_3 * wq_3_4 + x32_1_4 * wq_4_4 + x32_1_5 * wq_5_4)[23:8];
        bit<16> q_1_5 = (x32_1_0 * wq_0_5 + x32_1_1 * wq_1_5 + x32_1_2 * wq_2_5 + x32_1_3 * wq_3_5 + x32_1_4 * wq_4_5 + x32_1_5 * wq_5_5)[23:8];
        bit<16> q_2_3 = (x32_2_0 * wq_0_3 + x32_2_1 * wq_1_3 + x32_2_2 * wq_2_3 + x32_2_3 * wq_3_3 + x32_2_4 * wq_4_3 + x32_2_5 * wq_5_3)[23:8];
        bit<16> q_2_4 = (x32_2_0 * wq_0_4 + x32_2_1 * wq_1_4 + x32_2_2 * wq_2_4 + x32_2_3 * wq_3_4 + x32_2_4 * wq_4_4 + x32_2_5 * wq_5_4)[23:8];
        bit<16> q_2_5 = (x32_2_0 * wq_0_5 + x32_2_1 * wq_1_5 + x32_2_2 * wq_2_5 + x32_2_3 * wq_3_5 + x32_2_4 * wq_4_5 + x32_2_5 * wq_5_5)[23:8];
        bit<16> q_3_3 = (x32_3_0 * wq_0_3 + x32_3_1 * wq_1_3 + x32_3_2 * wq_2_3 + x32_3_3 * wq_3_3 + x32_3_4 * wq_4_3 + x32_3_5 * wq_5_3)[23:8];
        bit<16> q_3_4 = (x32_3_0 * wq_0_4 + x32_3_1 * wq_1_4 + x32_3_2 * wq_2_4 + x32_3_3 * wq_3_4 + x32_3_4 * wq_4_4 + x32_3_5 * wq_5_4)[23:8];
        bit<16> q_3_5 = (x32_3_0 * wq_0_5 + x32_3_1 * wq_1_5 + x32_3_2 * wq_2_5 + x32_3_3 * wq_3_5 + x32_3_4 * wq_4_5 + x32_3_5 * wq_5_5)[23:8];
        bit<16> q_4_3 = (x32_4_0 * wq_0_3 + x32_4_1 * wq_1_3 + x32_4_2 * wq_2_3 + x32_4_3 * wq_3_3 + x32_4_4 * wq_4_3 + x32_4_5 * wq_5_3)[23:8];
        bit<16> q_4_4 = (x32_4_0 * wq_0_4 + x32_4_1 * wq_1_4 + x32_4_2 * wq_2_4 + x32_4_3 * wq_3_4 + x32_4_4 * wq_4_4 + x32_4_5 * wq_5_4)[23:8];
        bit<16> q_4_5 = (x32_4_0 * wq_0_5 + x32_4_1 * wq_1_5 + x32_4_2 * wq_2_5 + x32_4_3 * wq_3_5 + x32_4_4 * wq_4_5 + x32_4_5 * wq_5_5)[23:8];
        bit<16> q_5_3 = (x32_5_0 * wq_0_3 + x32_5_1 * wq_1_3 + x32_5_2 * wq_2_3 + x32_5_3 * wq_3_3 + x32_5_4 * wq_4_3 + x32_5_5 * wq_5_3)[23:8];
        bit<16> q_5_4 = (x32_5_0 * wq_0_4 + x32_5_1 * wq_1_4 + x32_5_2 * wq_2_4 + x32_5_3 * wq_3_4 + x32_5_4 * wq_4_4 + x32_5_5 * wq_5_4)[23:8];
        bit<16> q_5_5 = (x32_5_0 * wq_0_5 + x32_5_1 * wq_1_5 + x32_5_2 * wq_2_5 + x32_5_3 * wq_3_5 + x32_5_4 * wq_4_5 + x32_5_5 * wq_5_5)[23:8];
        bit<16> q_6_3 = (x32_6_0 * wq_0_3 + x32_6_1 * wq_1_3 + x32_6_2 * wq_2_3 + x32_6_3 * wq_3_3 + x32_6_4 * wq_4_3 + x32_6_5 * wq_5_3)[23:8];
        bit<16> q_6_4 = (x32_6_0 * wq_0_4 + x32_6_1 * wq_1_4 + x32_6_2 * wq_2_4 + x32_6_3 * wq_3_4 + x32_6_4 * wq_4_4 + x32_6_5 * wq_5_4)[23:8];
        bit<16> q_6_5 = (x32_6_0 * wq_0_5 + x32_6_1 * wq_1_5 + x32_6_2 * wq_2_5 + x32_6_3 * wq_3_5 + x32_6_4 * wq_4_5 + x32_6_5 * wq_5_5)[23:8];
        bit<16> q_7_3 = (x32_7_0 * wq_0_3 + x32_7_1 * wq_1_3 + x32_7_2 * wq_2_3 + x32_7_3 * wq_3_3 + x32_7_4 * wq_4_3 + x32_7_5 * wq_5_3)[23:8];
        bit<16> q_7_4 = (x32_7_0 * wq_0_4 + x32_7_1 * wq_1_4 + x32_7_2 * wq_2_4 + x32_7_3 * wq_3_4 + x32_7_4 * wq_4_4 + x32_7_5 * wq_5_4)[23:8];
        bit<16> q_7_5 = (x32_7_0 * wq_0_5 + x32_7_1 * wq_1_5 + x32_7_2 * wq_2_5 + x32_7_3 * wq_3_5 + x32_7_4 * wq_4_5 + x32_7_5 * wq_5_5)[23:8];

        // 计算k
        bit<16> k_0_3 = (x32_0_0 * wk_0_3 + x32_0_1 * wk_1_3 + x32_0_2 * wk_2_3 + x32_0_3 * wk_3_3 + x32_0_4 * wk_4_3 + x32_0_5 * wk_5_3)[23:8];
        bit<16> k_0_4 = (x32_0_0 * wk_0_4 + x32_0_1 * wk_1_4 + x32_0_2 * wk_2_4 + x32_0_3 * wk_3_4 + x32_0_4 * wk_4_4 + x32_0_5 * wk_5_4)[23:8];
        bit<16> k_0_5 = (x32_0_0 * wk_0_5 + x32_0_1 * wk_1_5 + x32_0_2 * wk_2_5 + x32_0_3 * wk_3_5 + x32_0_4 * wk_4_5 + x32_0_5 * wk_5_5)[23:8];
        bit<16> k_1_3 = (x32_1_0 * wk_0_3 + x32_1_1 * wk_1_3 + x32_1_2 * wk_2_3 + x32_1_3 * wk_3_3 + x32_1_4 * wk_4_3 + x32_1_5 * wk_5_3)[23:8];
        bit<16> k_1_4 = (x32_1_0 * wk_0_4 + x32_1_1 * wk_1_4 + x32_1_2 * wk_2_4 + x32_1_3 * wk_3_4 + x32_1_4 * wk_4_4 + x32_1_5 * wk_5_4)[23:8];
        bit<16> k_1_5 = (x32_1_0 * wk_0_5 + x32_1_1 * wk_1_5 + x32_1_2 * wk_2_5 + x32_1_3 * wk_3_5 + x32_1_4 * wk_4_5 + x32_1_5 * wk_5_5)[23:8];
        bit<16> k_2_3 = (x32_2_0 * wk_0_3 + x32_2_1 * wk_1_3 + x32_2_2 * wk_2_3 + x32_2_3 * wk_3_3 + x32_2_4 * wk_4_3 + x32_2_5 * wk_5_3)[23:8];
        bit<16> k_2_4 = (x32_2_0 * wk_0_4 + x32_2_1 * wk_1_4 + x32_2_2 * wk_2_4 + x32_2_3 * wk_3_4 + x32_2_4 * wk_4_4 + x32_2_5 * wk_5_4)[23:8];
        bit<16> k_2_5 = (x32_2_0 * wk_0_5 + x32_2_1 * wk_1_5 + x32_2_2 * wk_2_5 + x32_2_3 * wk_3_5 + x32_2_4 * wk_4_5 + x32_2_5 * wk_5_5)[23:8];
        bit<16> k_3_3 = (x32_3_0 * wk_0_3 + x32_3_1 * wk_1_3 + x32_3_2 * wk_2_3 + x32_3_3 * wk_3_3 + x32_3_4 * wk_4_3 + x32_3_5 * wk_5_3)[23:8];
        bit<16> k_3_4 = (x32_3_0 * wk_0_4 + x32_3_1 * wk_1_4 + x32_3_2 * wk_2_4 + x32_3_3 * wk_3_4 + x32_3_4 * wk_4_4 + x32_3_5 * wk_5_4)[23:8];
        bit<16> k_3_5 = (x32_3_0 * wk_0_5 + x32_3_1 * wk_1_5 + x32_3_2 * wk_2_5 + x32_3_3 * wk_3_5 + x32_3_4 * wk_4_5 + x32_3_5 * wk_5_5)[23:8];
        bit<16> k_4_3 = (x32_4_0 * wk_0_3 + x32_4_1 * wk_1_3 + x32_4_2 * wk_2_3 + x32_4_3 * wk_3_3 + x32_4_4 * wk_4_3 + x32_4_5 * wk_5_3)[23:8];
        bit<16> k_4_4 = (x32_4_0 * wk_0_4 + x32_4_1 * wk_1_4 + x32_4_2 * wk_2_4 + x32_4_3 * wk_3_4 + x32_4_4 * wk_4_4 + x32_4_5 * wk_5_4)[23:8];
        bit<16> k_4_5 = (x32_4_0 * wk_0_5 + x32_4_1 * wk_1_5 + x32_4_2 * wk_2_5 + x32_4_3 * wk_3_5 + x32_4_4 * wk_4_5 + x32_4_5 * wk_5_5)[23:8];
        bit<16> k_5_3 = (x32_5_0 * wk_0_3 + x32_5_1 * wk_1_3 + x32_5_2 * wk_2_3 + x32_5_3 * wk_3_3 + x32_5_4 * wk_4_3 + x32_5_5 * wk_5_3)[23:8];
        bit<16> k_5_4 = (x32_5_0 * wk_0_4 + x32_5_1 * wk_1_4 + x32_5_2 * wk_2_4 + x32_5_3 * wk_3_4 + x32_5_4 * wk_4_4 + x32_5_5 * wk_5_4)[23:8];
        bit<16> k_5_5 = (x32_5_0 * wk_0_5 + x32_5_1 * wk_1_5 + x32_5_2 * wk_2_5 + x32_5_3 * wk_3_5 + x32_5_4 * wk_4_5 + x32_5_5 * wk_5_5)[23:8];
        bit<16> k_6_3 = (x32_6_0 * wk_0_3 + x32_6_1 * wk_1_3 + x32_6_2 * wk_2_3 + x32_6_3 * wk_3_3 + x32_6_4 * wk_4_3 + x32_6_5 * wk_5_3)[23:8];
        bit<16> k_6_4 = (x32_6_0 * wk_0_4 + x32_6_1 * wk_1_4 + x32_6_2 * wk_2_4 + x32_6_3 * wk_3_4 + x32_6_4 * wk_4_4 + x32_6_5 * wk_5_4)[23:8];
        bit<16> k_6_5 = (x32_6_0 * wk_0_5 + x32_6_1 * wk_1_5 + x32_6_2 * wk_2_5 + x32_6_3 * wk_3_5 + x32_6_4 * wk_4_5 + x32_6_5 * wk_5_5)[23:8];
        bit<16> k_7_3 = (x32_7_0 * wk_0_3 + x32_7_1 * wk_1_3 + x32_7_2 * wk_2_3 + x32_7_3 * wk_3_3 + x32_7_4 * wk_4_3 + x32_7_5 * wk_5_3)[23:8];
        bit<16> k_7_4 = (x32_7_0 * wk_0_4 + x32_7_1 * wk_1_4 + x32_7_2 * wk_2_4 + x32_7_3 * wk_3_4 + x32_7_4 * wk_4_4 + x32_7_5 * wk_5_4)[23:8];
        bit<16> k_7_5 = (x32_7_0 * wk_0_5 + x32_7_1 * wk_1_5 + x32_7_2 * wk_2_5 + x32_7_3 * wk_3_5 + x32_7_4 * wk_4_5 + x32_7_5 * wk_5_5)[23:8];
        ...
        bit<32> v_0_3 = (bit<32>) v32_0_3[31:8] | (((v32_0_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_0_4 = (bit<32>) v32_0_4[31:8] | (((v32_0_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_0_5 = (bit<32>) v32_0_5[31:8] | (((v32_0_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_1_3 = (bit<32>) v32_1_3[31:8] | (((v32_1_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_1_4 = (bit<32>) v32_1_4[31:8] | (((v32_1_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_1_5 = (bit<32>) v32_1_5[31:8] | (((v32_1_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_2_3 = (bit<32>) v32_2_3[31:8] | (((v32_2_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_2_4 = (bit<32>) v32_2_4[31:8] | (((v32_2_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_2_5 = (bit<32>) v32_2_5[31:8] | (((v32_2_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_3_3 = (bit<32>) v32_3_3[31:8] | (((v32_3_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_3_4 = (bit<32>) v32_3_4[31:8] | (((v32_3_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_3_5 = (bit<32>) v32_3_5[31:8] | (((v32_3_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_4_3 = (bit<32>) v32_4_3[31:8] | (((v32_4_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_4_4 = (bit<32>) v32_4_4[31:8] | (((v32_4_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_4_5 = (bit<32>) v32_4_5[31:8] | (((v32_4_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_5_3 = (bit<32>) v32_5_3[31:8] | (((v32_5_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_5_4 = (bit<32>) v32_5_4[31:8] | (((v32_5_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_5_5 = (bit<32>) v32_5_5[31:8] | (((v32_5_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_6_3 = (bit<32>) v32_6_3[31:8] | (((v32_6_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_6_4 = (bit<32>) v32_6_4[31:8] | (((v32_6_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_6_5 = (bit<32>) v32_6_5[31:8] | (((v32_6_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_7_3 = (bit<32>) v32_7_3[31:8] | (((v32_7_3[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_7_4 = (bit<32>) v32_7_4[31:8] | (((v32_7_4[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
        bit<32> v_7_5 = (bit<32>) v32_7_5[31:8] | (((v32_7_5[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0);
