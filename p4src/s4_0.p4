...
const bit<32> wq_0_0 = 0x00000043;
const bit<32> wq_0_1 = 0xFFFFFFAC;
const bit<32> wq_0_2 = 0x00000038;
const bit<32> wq_1_0 = 0xFFFFFFDE;
const bit<32> wq_1_1 = 0xFFFFFF8F;
const bit<32> wq_1_2 = 0xFFFFFFDA;
const bit<32> wq_2_0 = 0xFFFFFFB0;
const bit<32> wq_2_1 = 0xFFFFFFF4;
const bit<32> wq_2_2 = 0x0000005C;
const bit<32> wq_3_0 = 0x00000028;
const bit<32> wq_3_1 = 0xFFFFFFDD;
const bit<32> wq_3_2 = 0xFFFFFFAB;
const bit<32> wq_4_0 = 0x0000007F;
const bit<32> wq_4_1 = 0x00000025;
const bit<32> wq_4_2 = 0xFFFFFF93;
const bit<32> wq_5_0 = 0x0000003F;
const bit<32> wq_5_1 = 0x0000005B;
const bit<32> wq_5_2 = 0xFFFFFFD7;

const bit<16> wq_bias_0 = 0xFF94;
const bit<16> wq_bias_1 = 0x000b;
const bit<16> wq_bias_2 = 0xFFB2;

const bit<32> wk_0_0 = 0xFFFFFF96;
const bit<32> wk_0_1 = 0xFFFFFFB3;
const bit<32> wk_0_2 = 0x00000024;
const bit<32> wk_1_0 = 0x000000C7;
const bit<32> wk_1_1 = 0x0000004B;
const bit<32> wk_1_2 = 0xFFFFFF9E;
const bit<32> wk_2_0 = 0x0000002C;
const bit<32> wk_2_1 = 0x00000031;
const bit<32> wk_2_2 = 0xFFFFFFA2;
const bit<32> wk_3_0 = 0xFFFFFFB9;
const bit<32> wk_3_1 = 0x00000022;
const bit<32> wk_3_2 = 0x0000006D;
const bit<32> wk_4_0 = 0xFFFFFFD5;
const bit<32> wk_4_1 = 0x00000026;
const bit<32> wk_4_2 = 0xFFFFFF7E;
const bit<32> wk_5_0 = 0xFFFFFFB3;
const bit<32> wk_5_1 = 0xFFFFFF93;
const bit<32> wk_5_2 = 0x0000004E;

const bit<16> wk_bias_0 = 0x0059;
const bit<16> wk_bias_1 = 0xFFAE;
const bit<16> wk_bias_2 = 0xFFE7;

const bit<32> wv_0_0 = 0x00000048;
const bit<32> wv_0_1 = 0xFFFFFFF9;
const bit<32> wv_0_2 = 0xFFFFFFD7;
const bit<32> wv_1_0 = 0x0000003F;
const bit<32> wv_1_1 = 0x00000059;
const bit<32> wv_1_2 = 0x00000024;
const bit<32> wv_2_0 = 0x0000005B;
const bit<32> wv_2_1 = 0x00000046;
const bit<32> wv_2_2 = 0xFFFFFFEA;
const bit<32> wv_3_0 = 0x0000004C;
const bit<32> wv_3_1 = 0x00000066;
const bit<32> wv_3_2 = 0xFFFFFFA2;
const bit<32> wv_4_0 = 0xFFFFFFA9;
const bit<32> wv_4_1 = 0x0000002B;
const bit<32> wv_4_2 = 0xFFFFFFB3;
const bit<32> wv_5_0 = 0x00000048;
const bit<32> wv_5_1 = 0xFFFFFFC8;
const bit<32> wv_5_2 = 0xFFFFFFC8;

const bit<32> wv_bias_0 = 0x0000001B;
const bit<32> wv_bias_1 = 0x00000049;
const bit<32> wv_bias_2 = 0x0000005C;
...
control MyIngress(inout headers hdr,
    ...
    action calc_qk(){
        ...
        bit<32> x32_7_5 = (bit<32>) x_7_5 | (( x_7_5 & 0x8000) != 0 ? 32w0xFFFF0000 : 32w0x00000000);
               ...
               //计算q
        bit<16> q_0_0 = (x32_0_0 * wq_0_0 + x32_0_1 * wq_1_0 + x32_0_2 * wq_2_0 + x32_0_3 * wq_3_0 + x32_0_4 * wq_4_0 + x32_0_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_0_1 = (x32_0_0 * wq_0_1 + x32_0_1 * wq_1_1 + x32_0_2 * wq_2_1 + x32_0_3 * wq_3_1 + x32_0_4 * wq_4_1 + x32_0_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_0_2 = (x32_0_0 * wq_0_2 + x32_0_1 * wq_1_2 + x32_0_2 * wq_2_2 + x32_0_3 * wq_3_2 + x32_0_4 * wq_4_2 + x32_0_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_1_0 = (x32_1_0 * wq_0_0 + x32_1_1 * wq_1_0 + x32_1_2 * wq_2_0 + x32_1_3 * wq_3_0 + x32_1_4 * wq_4_0 + x32_1_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_1_1 = (x32_1_0 * wq_0_1 + x32_1_1 * wq_1_1 + x32_1_2 * wq_2_1 + x32_1_3 * wq_3_1 + x32_1_4 * wq_4_1 + x32_1_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_1_2 = (x32_1_0 * wq_0_2 + x32_1_1 * wq_1_2 + x32_1_2 * wq_2_2 + x32_1_3 * wq_3_2 + x32_1_4 * wq_4_2 + x32_1_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_2_0 = (x32_2_0 * wq_0_0 + x32_2_1 * wq_1_0 + x32_2_2 * wq_2_0 + x32_2_3 * wq_3_0 + x32_2_4 * wq_4_0 + x32_2_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_2_1 = (x32_2_0 * wq_0_1 + x32_2_1 * wq_1_1 + x32_2_2 * wq_2_1 + x32_2_3 * wq_3_1 + x32_2_4 * wq_4_1 + x32_2_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_2_2 = (x32_2_0 * wq_0_2 + x32_2_1 * wq_1_2 + x32_2_2 * wq_2_2 + x32_2_3 * wq_3_2 + x32_2_4 * wq_4_2 + x32_2_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_3_0 = (x32_3_0 * wq_0_0 + x32_3_1 * wq_1_0 + x32_3_2 * wq_2_0 + x32_3_3 * wq_3_0 + x32_3_4 * wq_4_0 + x32_3_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_3_1 = (x32_3_0 * wq_0_1 + x32_3_1 * wq_1_1 + x32_3_2 * wq_2_1 + x32_3_3 * wq_3_1 + x32_3_4 * wq_4_1 + x32_3_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_3_2 = (x32_3_0 * wq_0_2 + x32_3_1 * wq_1_2 + x32_3_2 * wq_2_2 + x32_3_3 * wq_3_2 + x32_3_4 * wq_4_2 + x32_3_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_4_0 = (x32_4_0 * wq_0_0 + x32_4_1 * wq_1_0 + x32_4_2 * wq_2_0 + x32_4_3 * wq_3_0 + x32_4_4 * wq_4_0 + x32_4_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_4_1 = (x32_4_0 * wq_0_1 + x32_4_1 * wq_1_1 + x32_4_2 * wq_2_1 + x32_4_3 * wq_3_1 + x32_4_4 * wq_4_1 + x32_4_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_4_2 = (x32_4_0 * wq_0_2 + x32_4_1 * wq_1_2 + x32_4_2 * wq_2_2 + x32_4_3 * wq_3_2 + x32_4_4 * wq_4_2 + x32_4_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_5_0 = (x32_5_0 * wq_0_0 + x32_5_1 * wq_1_0 + x32_5_2 * wq_2_0 + x32_5_3 * wq_3_0 + x32_5_4 * wq_4_0 + x32_5_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_5_1 = (x32_5_0 * wq_0_1 + x32_5_1 * wq_1_1 + x32_5_2 * wq_2_1 + x32_5_3 * wq_3_1 + x32_5_4 * wq_4_1 + x32_5_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_5_2 = (x32_5_0 * wq_0_2 + x32_5_1 * wq_1_2 + x32_5_2 * wq_2_2 + x32_5_3 * wq_3_2 + x32_5_4 * wq_4_2 + x32_5_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_6_0 = (x32_6_0 * wq_0_0 + x32_6_1 * wq_1_0 + x32_6_2 * wq_2_0 + x32_6_3 * wq_3_0 + x32_6_4 * wq_4_0 + x32_6_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_6_1 = (x32_6_0 * wq_0_1 + x32_6_1 * wq_1_1 + x32_6_2 * wq_2_1 + x32_6_3 * wq_3_1 + x32_6_4 * wq_4_1 + x32_6_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_6_2 = (x32_6_0 * wq_0_2 + x32_6_1 * wq_1_2 + x32_6_2 * wq_2_2 + x32_6_3 * wq_3_2 + x32_6_4 * wq_4_2 + x32_6_5 * wq_5_2)[23:8] + wq_bias_2;
        bit<16> q_7_0 = (x32_7_0 * wq_0_0 + x32_7_1 * wq_1_0 + x32_7_2 * wq_2_0 + x32_7_3 * wq_3_0 + x32_7_4 * wq_4_0 + x32_7_5 * wq_5_0)[23:8] + wq_bias_0;
        bit<16> q_7_1 = (x32_7_0 * wq_0_1 + x32_7_1 * wq_1_1 + x32_7_2 * wq_2_1 + x32_7_3 * wq_3_1 + x32_7_4 * wq_4_1 + x32_7_5 * wq_5_1)[23:8] + wq_bias_1;
        bit<16> q_7_2 = (x32_7_0 * wq_0_2 + x32_7_1 * wq_1_2 + x32_7_2 * wq_2_2 + x32_7_3 * wq_3_2 + x32_7_4 * wq_4_2 + x32_7_5 * wq_5_2)[23:8] + wq_bias_2;


        // 计算k
        bit<16> k_0_0 = (x32_0_0 * wk_0_0 + x32_0_1 * wk_1_0 + x32_0_2 * wk_2_0 + x32_0_3 * wk_3_0 + x32_0_4 * wk_4_0 + x32_0_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_0_1 = (x32_0_0 * wk_0_1 + x32_0_1 * wk_1_1 + x32_0_2 * wk_2_1 + x32_0_3 * wk_3_1 + x32_0_4 * wk_4_1 + x32_0_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_0_2 = (x32_0_0 * wk_0_2 + x32_0_1 * wk_1_2 + x32_0_2 * wk_2_2 + x32_0_3 * wk_3_2 + x32_0_4 * wk_4_2 + x32_0_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_1_0 = (x32_1_0 * wk_0_0 + x32_1_1 * wk_1_0 + x32_1_2 * wk_2_0 + x32_1_3 * wk_3_0 + x32_1_4 * wk_4_0 + x32_1_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_1_1 = (x32_1_0 * wk_0_1 + x32_1_1 * wk_1_1 + x32_1_2 * wk_2_1 + x32_1_3 * wk_3_1 + x32_1_4 * wk_4_1 + x32_1_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_1_2 = (x32_1_0 * wk_0_2 + x32_1_1 * wk_1_2 + x32_1_2 * wk_2_2 + x32_1_3 * wk_3_2 + x32_1_4 * wk_4_2 + x32_1_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_2_0 = (x32_2_0 * wk_0_0 + x32_2_1 * wk_1_0 + x32_2_2 * wk_2_0 + x32_2_3 * wk_3_0 + x32_2_4 * wk_4_0 + x32_2_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_2_1 = (x32_2_0 * wk_0_1 + x32_2_1 * wk_1_1 + x32_2_2 * wk_2_1 + x32_2_3 * wk_3_1 + x32_2_4 * wk_4_1 + x32_2_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_2_2 = (x32_2_0 * wk_0_2 + x32_2_1 * wk_1_2 + x32_2_2 * wk_2_2 + x32_2_3 * wk_3_2 + x32_2_4 * wk_4_2 + x32_2_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_3_0 = (x32_3_0 * wk_0_0 + x32_3_1 * wk_1_0 + x32_3_2 * wk_2_0 + x32_3_3 * wk_3_0 + x32_3_4 * wk_4_0 + x32_3_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_3_1 = (x32_3_0 * wk_0_1 + x32_3_1 * wk_1_1 + x32_3_2 * wk_2_1 + x32_3_3 * wk_3_1 + x32_3_4 * wk_4_1 + x32_3_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_3_2 = (x32_3_0 * wk_0_2 + x32_3_1 * wk_1_2 + x32_3_2 * wk_2_2 + x32_3_3 * wk_3_2 + x32_3_4 * wk_4_2 + x32_3_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_4_0 = (x32_4_0 * wk_0_0 + x32_4_1 * wk_1_0 + x32_4_2 * wk_2_0 + x32_4_3 * wk_3_0 + x32_4_4 * wk_4_0 + x32_4_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_4_1 = (x32_4_0 * wk_0_1 + x32_4_1 * wk_1_1 + x32_4_2 * wk_2_1 + x32_4_3 * wk_3_1 + x32_4_4 * wk_4_1 + x32_4_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_4_2 = (x32_4_0 * wk_0_2 + x32_4_1 * wk_1_2 + x32_4_2 * wk_2_2 + x32_4_3 * wk_3_2 + x32_4_4 * wk_4_2 + x32_4_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_5_0 = (x32_5_0 * wk_0_0 + x32_5_1 * wk_1_0 + x32_5_2 * wk_2_0 + x32_5_3 * wk_3_0 + x32_5_4 * wk_4_0 + x32_5_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_5_1 = (x32_5_0 * wk_0_1 + x32_5_1 * wk_1_1 + x32_5_2 * wk_2_1 + x32_5_3 * wk_3_1 + x32_5_4 * wk_4_1 + x32_5_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_5_2 = (x32_5_0 * wk_0_2 + x32_5_1 * wk_1_2 + x32_5_2 * wk_2_2 + x32_5_3 * wk_3_2 + x32_5_4 * wk_4_2 + x32_5_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_6_0 = (x32_6_0 * wk_0_0 + x32_6_1 * wk_1_0 + x32_6_2 * wk_2_0 + x32_6_3 * wk_3_0 + x32_6_4 * wk_4_0 + x32_6_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_6_1 = (x32_6_0 * wk_0_1 + x32_6_1 * wk_1_1 + x32_6_2 * wk_2_1 + x32_6_3 * wk_3_1 + x32_6_4 * wk_4_1 + x32_6_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_6_2 = (x32_6_0 * wk_0_2 + x32_6_1 * wk_1_2 + x32_6_2 * wk_2_2 + x32_6_3 * wk_3_2 + x32_6_4 * wk_4_2 + x32_6_5 * wk_5_2)[23:8] + wk_bias_2;
        bit<16> k_7_0 = (x32_7_0 * wk_0_0 + x32_7_1 * wk_1_0 + x32_7_2 * wk_2_0 + x32_7_3 * wk_3_0 + x32_7_4 * wk_4_0 + x32_7_5 * wk_5_0)[23:8] + wk_bias_0;
        bit<16> k_7_1 = (x32_7_0 * wk_0_1 + x32_7_1 * wk_1_1 + x32_7_2 * wk_2_1 + x32_7_3 * wk_3_1 + x32_7_4 * wk_4_1 + x32_7_5 * wk_5_1)[23:8] + wk_bias_1;
        bit<16> k_7_2 = (x32_7_0 * wk_0_2 + x32_7_1 * wk_1_2 + x32_7_2 * wk_2_2 + x32_7_3 * wk_3_2 + x32_7_4 * wk_4_2 + x32_7_5 * wk_5_2)[23:8] + wk_bias_2;

        // 计算v
        bit<32> v32_0_0 = x32_0_0 * wv_0_0 + x32_0_1 * wv_1_0 + x32_0_2 * wv_2_0 + x32_0_3 * wv_3_0 + x32_0_4 * wv_4_0 + x32_0_5 * wv_5_0;
        bit<32> v32_0_1 = x32_0_0 * wv_0_1 + x32_0_1 * wv_1_1 + x32_0_2 * wv_2_1 + x32_0_3 * wv_3_1 + x32_0_4 * wv_4_1 + x32_0_5 * wv_5_1;
        bit<32> v32_0_2 = x32_0_0 * wv_0_2 + x32_0_1 * wv_1_2 + x32_0_2 * wv_2_2 + x32_0_3 * wv_3_2 + x32_0_4 * wv_4_2 + x32_0_5 * wv_5_2;
        bit<32> v32_1_0 = x32_1_0 * wv_0_0 + x32_1_1 * wv_1_0 + x32_1_2 * wv_2_0 + x32_1_3 * wv_3_0 + x32_1_4 * wv_4_0 + x32_1_5 * wv_5_0;
        bit<32> v32_1_1 = x32_1_0 * wv_0_1 + x32_1_1 * wv_1_1 + x32_1_2 * wv_2_1 + x32_1_3 * wv_3_1 + x32_1_4 * wv_4_1 + x32_1_5 * wv_5_1;
        bit<32> v32_1_2 = x32_1_0 * wv_0_2 + x32_1_1 * wv_1_2 + x32_1_2 * wv_2_2 + x32_1_3 * wv_3_2 + x32_1_4 * wv_4_2 + x32_1_5 * wv_5_2;
        bit<32> v32_2_0 = x32_2_0 * wv_0_0 + x32_2_1 * wv_1_0 + x32_2_2 * wv_2_0 + x32_2_3 * wv_3_0 + x32_2_4 * wv_4_0 + x32_2_5 * wv_5_0;
        bit<32> v32_2_1 = x32_2_0 * wv_0_1 + x32_2_1 * wv_1_1 + x32_2_2 * wv_2_1 + x32_2_3 * wv_3_1 + x32_2_4 * wv_4_1 + x32_2_5 * wv_5_1;
        bit<32> v32_2_2 = x32_2_0 * wv_0_2 + x32_2_1 * wv_1_2 + x32_2_2 * wv_2_2 + x32_2_3 * wv_3_2 + x32_2_4 * wv_4_2 + x32_2_5 * wv_5_2;
        bit<32> v32_3_0 = x32_3_0 * wv_0_0 + x32_3_1 * wv_1_0 + x32_3_2 * wv_2_0 + x32_3_3 * wv_3_0 + x32_3_4 * wv_4_0 + x32_3_5 * wv_5_0;
        bit<32> v32_3_1 = x32_3_0 * wv_0_1 + x32_3_1 * wv_1_1 + x32_3_2 * wv_2_1 + x32_3_3 * wv_3_1 + x32_3_4 * wv_4_1 + x32_3_5 * wv_5_1;
        bit<32> v32_3_2 = x32_3_0 * wv_0_2 + x32_3_1 * wv_1_2 + x32_3_2 * wv_2_2 + x32_3_3 * wv_3_2 + x32_3_4 * wv_4_2 + x32_3_5 * wv_5_2;
        bit<32> v32_4_0 = x32_4_0 * wv_0_0 + x32_4_1 * wv_1_0 + x32_4_2 * wv_2_0 + x32_4_3 * wv_3_0 + x32_4_4 * wv_4_0 + x32_4_5 * wv_5_0;
        bit<32> v32_4_1 = x32_4_0 * wv_0_1 + x32_4_1 * wv_1_1 + x32_4_2 * wv_2_1 + x32_4_3 * wv_3_1 + x32_4_4 * wv_4_1 + x32_4_5 * wv_5_1;
        bit<32> v32_4_2 = x32_4_0 * wv_0_2 + x32_4_1 * wv_1_2 + x32_4_2 * wv_2_2 + x32_4_3 * wv_3_2 + x32_4_4 * wv_4_2 + x32_4_5 * wv_5_2;
        bit<32> v32_5_0 = x32_5_0 * wv_0_0 + x32_5_1 * wv_1_0 + x32_5_2 * wv_2_0 + x32_5_3 * wv_3_0 + x32_5_4 * wv_4_0 + x32_5_5 * wv_5_0;
        bit<32> v32_5_1 = x32_5_0 * wv_0_1 + x32_5_1 * wv_1_1 + x32_5_2 * wv_2_1 + x32_5_3 * wv_3_1 + x32_5_4 * wv_4_1 + x32_5_5 * wv_5_1;
        bit<32> v32_5_2 = x32_5_0 * wv_0_2 + x32_5_1 * wv_1_2 + x32_5_2 * wv_2_2 + x32_5_3 * wv_3_2 + x32_5_4 * wv_4_2 + x32_5_5 * wv_5_2;
        bit<32> v32_6_0 = x32_6_0 * wv_0_0 + x32_6_1 * wv_1_0 + x32_6_2 * wv_2_0 + x32_6_3 * wv_3_0 + x32_6_4 * wv_4_0 + x32_6_5 * wv_5_0;
        bit<32> v32_6_1 = x32_6_0 * wv_0_1 + x32_6_1 * wv_1_1 + x32_6_2 * wv_2_1 + x32_6_3 * wv_3_1 + x32_6_4 * wv_4_1 + x32_6_5 * wv_5_1;
        bit<32> v32_6_2 = x32_6_0 * wv_0_2 + x32_6_1 * wv_1_2 + x32_6_2 * wv_2_2 + x32_6_3 * wv_3_2 + x32_6_4 * wv_4_2 + x32_6_5 * wv_5_2;
        bit<32> v32_7_0 = x32_7_0 * wv_0_0 + x32_7_1 * wv_1_0 + x32_7_2 * wv_2_0 + x32_7_3 * wv_3_0 + x32_7_4 * wv_4_0 + x32_7_5 * wv_5_0;
        bit<32> v32_7_1 = x32_7_0 * wv_0_1 + x32_7_1 * wv_1_1 + x32_7_2 * wv_2_1 + x32_7_3 * wv_3_1 + x32_7_4 * wv_4_1 + x32_7_5 * wv_5_1;
        bit<32> v32_7_2 = x32_7_0 * wv_0_2 + x32_7_1 * wv_1_2 + x32_7_2 * wv_2_2 + x32_7_3 * wv_3_2 + x32_7_4 * wv_4_2 + x32_7_5 * wv_5_2;

        bit<32> v_0_0 = ((bit<32>) v32_0_0[31:8] | (((v32_0_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_0_1 = ((bit<32>) v32_0_1[31:8] | (((v32_0_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_0_2 = ((bit<32>) v32_0_2[31:8] | (((v32_0_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_1_0 = ((bit<32>) v32_1_0[31:8] | (((v32_1_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_1_1 = ((bit<32>) v32_1_1[31:8] | (((v32_1_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_1_2 = ((bit<32>) v32_1_2[31:8] | (((v32_1_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_2_0 = ((bit<32>) v32_2_0[31:8] | (((v32_2_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_2_1 = ((bit<32>) v32_2_1[31:8] | (((v32_2_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_2_2 = ((bit<32>) v32_2_2[31:8] | (((v32_2_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_3_0 = ((bit<32>) v32_3_0[31:8] | (((v32_3_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_3_1 = ((bit<32>) v32_3_1[31:8] | (((v32_3_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_3_2 = ((bit<32>) v32_3_2[31:8] | (((v32_3_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_4_0 = ((bit<32>) v32_4_0[31:8] | (((v32_4_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_4_1 = ((bit<32>) v32_4_1[31:8] | (((v32_4_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_4_2 = ((bit<32>) v32_4_2[31:8] | (((v32_4_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_5_0 = ((bit<32>) v32_5_0[31:8] | (((v32_5_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_5_1 = ((bit<32>) v32_5_1[31:8] | (((v32_5_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_5_2 = ((bit<32>) v32_5_2[31:8] | (((v32_5_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_6_0 = ((bit<32>) v32_6_0[31:8] | (((v32_6_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_6_1 = ((bit<32>) v32_6_1[31:8] | (((v32_6_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_6_2 = ((bit<32>) v32_6_2[31:8] | (((v32_6_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
        bit<32> v_7_0 = ((bit<32>) v32_7_0[31:8] | (((v32_7_0[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_0;
        bit<32> v_7_1 = ((bit<32>) v32_7_1[31:8] | (((v32_7_1[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_1;
        bit<32> v_7_2 = ((bit<32>) v32_7_2[31:8] | (((v32_7_2[31:8] & 0x800000) != 0) ? 32w0xFF000000 : 0)) +  wv_bias_2;
