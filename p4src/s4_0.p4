...
const bit<32> wq_0_0 = 0xffffbbed;
const bit<32> wq_0_1 = 0xffffd973;
const bit<32> wq_0_2 = 0xffffd015;
const bit<32> wq_1_0 = 0x00005b06;
const bit<32> wq_1_1 = 0x00006027;
const bit<32> wq_1_2 = 0x000024ae;
const bit<32> wq_2_0 = 0xffffa9d3;
const bit<32> wq_2_1 = 0x0000106e;
const bit<32> wq_2_2 = 0xffffd114;
const bit<32> wq_3_0 = 0x000023df;
const bit<32> wq_3_1 = 0xffffc405;
const bit<32> wq_3_2 = 0x000070d0;
const bit<32> wq_4_0 = 0x00006ae0;
const bit<32> wq_4_1 = 0x00000093;
const bit<32> wq_4_2 = 0x00005fee;
const bit<32> wq_5_0 = 0x00000f47;
const bit<32> wq_5_1 = 0x00002368;
const bit<32> wq_5_2 = 0xffffa16f;
const bit<32> wk_0_0 = 0x0000262a;
const bit<32> wk_0_1 = 0x00006b46;
const bit<32> wk_0_2 = 0xffff94c4;
const bit<32> wk_1_0 = 0xffff8806;
const bit<32> wk_1_1 = 0x00005504;
const bit<32> wk_1_2 = 0x00003660;
const bit<32> wk_2_0 = 0xffffa853;
const bit<32> wk_2_1 = 0x00000ffb;
const bit<32> wk_2_2 = 0xffffee18;
const bit<32> wk_3_0 = 0xffff8d9d;
const bit<32> wk_3_1 = 0xfffff134;
const bit<32> wk_3_2 = 0x00003335;
const bit<32> wk_4_0 = 0x000049bc;
const bit<32> wk_4_1 = 0x000001f8;
const bit<32> wk_4_2 = 0x000077f7;
const bit<32> wk_5_0 = 0xffff9728;
const bit<32> wk_5_1 = 0xffffd5fd;
const bit<32> wk_5_2 = 0x00006dad;
const bit<32> wv_0_0 = 0xffff8c11;
const bit<32> wv_0_1 = 0x00005ef1;
const bit<32> wv_0_2 = 0x00002f70;
const bit<32> wv_1_0 = 0x00000706;
const bit<32> wv_1_1 = 0xffff8a1e;
const bit<32> wv_1_2 = 0xfffff753;
const bit<32> wv_2_0 = 0xffffd67b;
const bit<32> wv_2_1 = 0x00004504;
const bit<32> wv_2_2 = 0xffff9e05;
const bit<32> wv_3_0 = 0xffffbbbc;
const bit<32> wv_3_1 = 0xffff95c3;
const bit<32> wv_3_2 = 0x0000268d;
const bit<32> wv_4_0 = 0x00004889;
const bit<32> wv_4_1 = 0x00007037;
const bit<32> wv_4_2 = 0x00001038;
const bit<32> wv_5_0 = 0x00005ae8;
const bit<32> wv_5_1 = 0xffffdf1e;
const bit<32> wv_5_2 = 0xffff90ad;
...
control MyIngress(inout headers hdr,
    ...
    action calc_qk(){
        ...
        //计算q
        bit<16> q_0_0 = (x32_0_0 * wq_0_0 + x32_0_1 * wq_1_0 + x32_0_2 * wq_2_0 + x32_0_3 * wq_3_0 + x32_0_4 * wq_4_0 + x32_0_5 * wq_5_0)[23:8];
        bit<16> q_0_1 = (x32_0_0 * wq_0_1 + x32_0_1 * wq_1_1 + x32_0_2 * wq_2_1 + x32_0_3 * wq_3_1 + x32_0_4 * wq_4_1 + x32_0_5 * wq_5_1)[23:8];
        bit<16> q_0_2 = (x32_0_0 * wq_0_2 + x32_0_1 * wq_1_2 + x32_0_2 * wq_2_2 + x32_0_3 * wq_3_2 + x32_0_4 * wq_4_2 + x32_0_5 * wq_5_2)[23:8];
        bit<16> q_1_0 = (x32_1_0 * wq_0_0 + x32_1_1 * wq_1_0 + x32_1_2 * wq_2_0 + x32_1_3 * wq_3_0 + x32_1_4 * wq_4_0 + x32_1_5 * wq_5_0)[23:8];
        bit<16> q_1_1 = (x32_1_0 * wq_0_1 + x32_1_1 * wq_1_1 + x32_1_2 * wq_2_1 + x32_1_3 * wq_3_1 + x32_1_4 * wq_4_1 + x32_1_5 * wq_5_1)[23:8];
        bit<16> q_1_2 = (x32_1_0 * wq_0_2 + x32_1_1 * wq_1_2 + x32_1_2 * wq_2_2 + x32_1_3 * wq_3_2 + x32_1_4 * wq_4_2 + x32_1_5 * wq_5_2)[23:8];
        bit<16> q_2_0 = (x32_2_0 * wq_0_0 + x32_2_1 * wq_1_0 + x32_2_2 * wq_2_0 + x32_2_3 * wq_3_0 + x32_2_4 * wq_4_0 + x32_2_5 * wq_5_0)[23:8];
        bit<16> q_2_1 = (x32_2_0 * wq_0_1 + x32_2_1 * wq_1_1 + x32_2_2 * wq_2_1 + x32_2_3 * wq_3_1 + x32_2_4 * wq_4_1 + x32_2_5 * wq_5_1)[23:8];
        bit<16> q_2_2 = (x32_2_0 * wq_0_2 + x32_2_1 * wq_1_2 + x32_2_2 * wq_2_2 + x32_2_3 * wq_3_2 + x32_2_4 * wq_4_2 + x32_2_5 * wq_5_2)[23:8];
        bit<16> q_3_0 = (x32_3_0 * wq_0_0 + x32_3_1 * wq_1_0 + x32_3_2 * wq_2_0 + x32_3_3 * wq_3_0 + x32_3_4 * wq_4_0 + x32_3_5 * wq_5_0)[23:8];
        bit<16> q_3_1 = (x32_3_0 * wq_0_1 + x32_3_1 * wq_1_1 + x32_3_2 * wq_2_1 + x32_3_3 * wq_3_1 + x32_3_4 * wq_4_1 + x32_3_5 * wq_5_1)[23:8];
        bit<16> q_3_2 = (x32_3_0 * wq_0_2 + x32_3_1 * wq_1_2 + x32_3_2 * wq_2_2 + x32_3_3 * wq_3_2 + x32_3_4 * wq_4_2 + x32_3_5 * wq_5_2)[23:8];
        bit<16> q_4_0 = (x32_4_0 * wq_0_0 + x32_4_1 * wq_1_0 + x32_4_2 * wq_2_0 + x32_4_3 * wq_3_0 + x32_4_4 * wq_4_0 + x32_4_5 * wq_5_0)[23:8];
        bit<16> q_4_1 = (x32_4_0 * wq_0_1 + x32_4_1 * wq_1_1 + x32_4_2 * wq_2_1 + x32_4_3 * wq_3_1 + x32_4_4 * wq_4_1 + x32_4_5 * wq_5_1)[23:8];
        bit<16> q_4_2 = (x32_4_0 * wq_0_2 + x32_4_1 * wq_1_2 + x32_4_2 * wq_2_2 + x32_4_3 * wq_3_2 + x32_4_4 * wq_4_2 + x32_4_5 * wq_5_2)[23:8];
        bit<16> q_5_0 = (x32_5_0 * wq_0_0 + x32_5_1 * wq_1_0 + x32_5_2 * wq_2_0 + x32_5_3 * wq_3_0 + x32_5_4 * wq_4_0 + x32_5_5 * wq_5_0)[23:8];
        bit<16> q_5_1 = (x32_5_0 * wq_0_1 + x32_5_1 * wq_1_1 + x32_5_2 * wq_2_1 + x32_5_3 * wq_3_1 + x32_5_4 * wq_4_1 + x32_5_5 * wq_5_1)[23:8];
        bit<16> q_5_2 = (x32_5_0 * wq_0_2 + x32_5_1 * wq_1_2 + x32_5_2 * wq_2_2 + x32_5_3 * wq_3_2 + x32_5_4 * wq_4_2 + x32_5_5 * wq_5_2)[23:8];
        bit<16> q_6_0 = (x32_6_0 * wq_0_0 + x32_6_1 * wq_1_0 + x32_6_2 * wq_2_0 + x32_6_3 * wq_3_0 + x32_6_4 * wq_4_0 + x32_6_5 * wq_5_0)[23:8];
        bit<16> q_6_1 = (x32_6_0 * wq_0_1 + x32_6_1 * wq_1_1 + x32_6_2 * wq_2_1 + x32_6_3 * wq_3_1 + x32_6_4 * wq_4_1 + x32_6_5 * wq_5_1)[23:8];
        bit<16> q_6_2 = (x32_6_0 * wq_0_2 + x32_6_1 * wq_1_2 + x32_6_2 * wq_2_2 + x32_6_3 * wq_3_2 + x32_6_4 * wq_4_2 + x32_6_5 * wq_5_2)[23:8];
        bit<16> q_7_0 = (x32_7_0 * wq_0_0 + x32_7_1 * wq_1_0 + x32_7_2 * wq_2_0 + x32_7_3 * wq_3_0 + x32_7_4 * wq_4_0 + x32_7_5 * wq_5_0)[23:8];
        bit<16> q_7_1 = (x32_7_0 * wq_0_1 + x32_7_1 * wq_1_1 + x32_7_2 * wq_2_1 + x32_7_3 * wq_3_1 + x32_7_4 * wq_4_1 + x32_7_5 * wq_5_1)[23:8];
        bit<16> q_7_2 = (x32_7_0 * wq_0_2 + x32_7_1 * wq_1_2 + x32_7_2 * wq_2_2 + x32_7_3 * wq_3_2 + x32_7_4 * wq_4_2 + x32_7_5 * wq_5_2)[23:8];


        // 计算k
        bit<16> k_0_0 = (x32_0_0 * wk_0_0 + x32_0_1 * wk_1_0 + x32_0_2 * wk_2_0 + x32_0_3 * wk_3_0 + x32_0_4 * wk_4_0 + x32_0_5 * wk_5_0)[23:8];
        bit<16> k_0_1 = (x32_0_0 * wk_0_1 + x32_0_1 * wk_1_1 + x32_0_2 * wk_2_1 + x32_0_3 * wk_3_1 + x32_0_4 * wk_4_1 + x32_0_5 * wk_5_1)[23:8];
        bit<16> k_0_2 = (x32_0_0 * wk_0_2 + x32_0_1 * wk_1_2 + x32_0_2 * wk_2_2 + x32_0_3 * wk_3_2 + x32_0_4 * wk_4_2 + x32_0_5 * wk_5_2)[23:8];
        bit<16> k_1_0 = (x32_1_0 * wk_0_0 + x32_1_1 * wk_1_0 + x32_1_2 * wk_2_0 + x32_1_3 * wk_3_0 + x32_1_4 * wk_4_0 + x32_1_5 * wk_5_0)[23:8];
        bit<16> k_1_1 = (x32_1_0 * wk_0_1 + x32_1_1 * wk_1_1 + x32_1_2 * wk_2_1 + x32_1_3 * wk_3_1 + x32_1_4 * wk_4_1 + x32_1_5 * wk_5_1)[23:8];
        bit<16> k_1_2 = (x32_1_0 * wk_0_2 + x32_1_1 * wk_1_2 + x32_1_2 * wk_2_2 + x32_1_3 * wk_3_2 + x32_1_4 * wk_4_2 + x32_1_5 * wk_5_2)[23:8];
        bit<16> k_2_0 = (x32_2_0 * wk_0_0 + x32_2_1 * wk_1_0 + x32_2_2 * wk_2_0 + x32_2_3 * wk_3_0 + x32_2_4 * wk_4_0 + x32_2_5 * wk_5_0)[23:8];
        bit<16> k_2_1 = (x32_2_0 * wk_0_1 + x32_2_1 * wk_1_1 + x32_2_2 * wk_2_1 + x32_2_3 * wk_3_1 + x32_2_4 * wk_4_1 + x32_2_5 * wk_5_1)[23:8];
        bit<16> k_2_2 = (x32_2_0 * wk_0_2 + x32_2_1 * wk_1_2 + x32_2_2 * wk_2_2 + x32_2_3 * wk_3_2 + x32_2_4 * wk_4_2 + x32_2_5 * wk_5_2)[23:8];
        bit<16> k_3_0 = (x32_3_0 * wk_0_0 + x32_3_1 * wk_1_0 + x32_3_2 * wk_2_0 + x32_3_3 * wk_3_0 + x32_3_4 * wk_4_0 + x32_3_5 * wk_5_0)[23:8];
        bit<16> k_3_1 = (x32_3_0 * wk_0_1 + x32_3_1 * wk_1_1 + x32_3_2 * wk_2_1 + x32_3_3 * wk_3_1 + x32_3_4 * wk_4_1 + x32_3_5 * wk_5_1)[23:8];
        bit<16> k_3_2 = (x32_3_0 * wk_0_2 + x32_3_1 * wk_1_2 + x32_3_2 * wk_2_2 + x32_3_3 * wk_3_2 + x32_3_4 * wk_4_2 + x32_3_5 * wk_5_2)[23:8];
        bit<16> k_4_0 = (x32_4_0 * wk_0_0 + x32_4_1 * wk_1_0 + x32_4_2 * wk_2_0 + x32_4_3 * wk_3_0 + x32_4_4 * wk_4_0 + x32_4_5 * wk_5_0)[23:8];
        bit<16> k_4_1 = (x32_4_0 * wk_0_1 + x32_4_1 * wk_1_1 + x32_4_2 * wk_2_1 + x32_4_3 * wk_3_1 + x32_4_4 * wk_4_1 + x32_4_5 * wk_5_1)[23:8];
        bit<16> k_4_2 = (x32_4_0 * wk_0_2 + x32_4_1 * wk_1_2 + x32_4_2 * wk_2_2 + x32_4_3 * wk_3_2 + x32_4_4 * wk_4_2 + x32_4_5 * wk_5_2)[23:8];
        bit<16> k_5_0 = (x32_5_0 * wk_0_0 + x32_5_1 * wk_1_0 + x32_5_2 * wk_2_0 + x32_5_3 * wk_3_0 + x32_5_4 * wk_4_0 + x32_5_5 * wk_5_0)[23:8];
        bit<16> k_5_1 = (x32_5_0 * wk_0_1 + x32_5_1 * wk_1_1 + x32_5_2 * wk_2_1 + x32_5_3 * wk_3_1 + x32_5_4 * wk_4_1 + x32_5_5 * wk_5_1)[23:8];
        bit<16> k_5_2 = (x32_5_0 * wk_0_2 + x32_5_1 * wk_1_2 + x32_5_2 * wk_2_2 + x32_5_3 * wk_3_2 + x32_5_4 * wk_4_2 + x32_5_5 * wk_5_2)[23:8];
        bit<16> k_6_0 = (x32_6_0 * wk_0_0 + x32_6_1 * wk_1_0 + x32_6_2 * wk_2_0 + x32_6_3 * wk_3_0 + x32_6_4 * wk_4_0 + x32_6_5 * wk_5_0)[23:8];
        bit<16> k_6_1 = (x32_6_0 * wk_0_1 + x32_6_1 * wk_1_1 + x32_6_2 * wk_2_1 + x32_6_3 * wk_3_1 + x32_6_4 * wk_4_1 + x32_6_5 * wk_5_1)[23:8];
        bit<16> k_6_2 = (x32_6_0 * wk_0_2 + x32_6_1 * wk_1_2 + x32_6_2 * wk_2_2 + x32_6_3 * wk_3_2 + x32_6_4 * wk_4_2 + x32_6_5 * wk_5_2)[23:8];
        bit<16> k_7_0 = (x32_7_0 * wk_0_0 + x32_7_1 * wk_1_0 + x32_7_2 * wk_2_0 + x32_7_3 * wk_3_0 + x32_7_4 * wk_4_0 + x32_7_5 * wk_5_0)[23:8];
        bit<16> k_7_1 = (x32_7_0 * wk_0_1 + x32_7_1 * wk_1_1 + x32_7_2 * wk_2_1 + x32_7_3 * wk_3_1 + x32_7_4 * wk_4_1 + x32_7_5 * wk_5_1)[23:8];
        bit<16> k_7_2 = (x32_7_0 * wk_0_2 + x32_7_1 * wk_1_2 + x32_7_2 * wk_2_2 + x32_7_3 * wk_3_2 + x32_7_4 * wk_4_2 + x32_7_5 * wk_5_2)[23:8];
