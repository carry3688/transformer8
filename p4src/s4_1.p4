...
const bit<32> wq_0_3 = 0xFFFFFFBE;
const bit<32> wq_0_4 = 0xFFFFFF7D;
const bit<32> wq_0_5 = 0xFFFFFFEE;
const bit<32> wq_1_3 = 0xFFFFFFC4;
const bit<32> wq_1_4 = 0x0000003A;
const bit<32> wq_1_5 = 0xFFFFFF6B;
const bit<32> wq_2_3 = 0xFFFFFFCF;
const bit<32> wq_2_4 = 0x0000003A;
const bit<32> wq_2_5 = 0xFFFFFFAF;
const bit<32> wq_3_3 = 0x00000030;
const bit<32> wq_3_4 = 0x00000048;
const bit<32> wq_3_5 = 0x0000003C;
const bit<32> wq_4_3 = 0xFFFFFFA0;
const bit<32> wq_4_4 = 0x0000003E;
const bit<32> wq_4_5 = 0x00000062;
const bit<32> wq_5_3 = 0x0000001B;
const bit<32> wq_5_4 = 0xFFFFFFD3;
const bit<32> wq_5_5 = 0xFFFFFFB0;

const bit<16> wq_bias_3 = 0x0066;
const bit<16> wq_bias_4 = 0x000D;
const bit<16> wq_bias_5 = 0xFFBD;

const bit<32> wk_0_3 = 0x00000039;
const bit<32> wk_0_4 = 0x0000000D;
const bit<32> wk_0_5 = 0x00000008;

const bit<32> wk_1_3 = 0xFFFFFFAD;
const bit<32> wk_1_4 = 0xFFFFFF91;
const bit<32> wk_1_5 = 0xFFFFFFCF;
const bit<32> wk_2_3 = 0x00000020;
const bit<32> wk_2_4 = 0x0000001E;
const bit<32> wk_2_5 = 0x00000065;
const bit<32> wk_3_3 = 0x0000006D;
const bit<32> wk_3_4 = 0xFFFFFFB2;
const bit<32> wk_3_5 = 0x0000002F;
const bit<32> wk_4_3 = 0x0000000F;
const bit<32> wk_4_4 = 0x0000003C;
const bit<32> wk_4_5 = 0xFFFFFF80;
const bit<32> wk_5_3 = 0x0000000B;
const bit<32> wk_5_4 = 0xFFFFFFF8;
const bit<32> wk_5_5 = 0x00000062;

const bit<16> wk_bias_3 = 0xFFDF;
const bit<16> wk_bias_4 = 0x0028;
const bit<16> wk_bias_5 = 0x0034;

const bit<32> wv_0_3 = 0x00000024;
const bit<32> wv_0_4 = 0xFFFFFFD2;
const bit<32> wv_0_5 = 0xFFFFFFD6;
const bit<32> wv_1_3 = 0x00000054;
const bit<32> wv_1_4 = 0xFFFFFFB5;
const bit<32> wv_1_5 = 0x0000000B;
const bit<32> wv_2_3 = 0xFFFFFFE2;
const bit<32> wv_2_4 = 0x0000006D;
const bit<32> wv_2_5 = 0xFFFFFFBC;
const bit<32> wv_3_3 = 0xFFFFFFBC;
const bit<32> wv_3_4 = 0xFFFFFFCB;
const bit<32> wv_3_5 = 0x00000079;
const bit<32> wv_4_3 = 0xFFFFFFC5;
const bit<32> wv_4_4 = 0xFFFFFFDB;
const bit<32> wv_4_5 = 0x00000055;
const bit<32> wv_5_3 = 0x0000003B;
const bit<32> wv_5_4 = 0xFFFFFFD5;
const bit<32> wv_5_5 = 0xFFFFFFA4;

const bit<32> wv_bias_3 = 0xFFFFFFBE;
const bit<32> wv_bias_4 = 0xFFFFFFED;
const bit<32> wv_bias_5 = 0x00000010;
