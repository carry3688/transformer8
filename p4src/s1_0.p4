...
const bit<32> wq_0_0 = 0x00000021;
const bit<32> wq_0_1 = 0xFFFFFFED;
const bit<32> wq_0_2 = 0xFFFFFFFF;
const bit<32> wq_1_0 = 0x00000029;
const bit<32> wq_1_1 = 0xFFFFFFEA;
const bit<32> wq_1_2 = 0x00000001;
const bit<32> wq_2_0 = 0xFFFFFFBD;
const bit<32> wq_2_1 = 0xFFFFFFAC;
const bit<32> wq_2_2 = 0xFFFFFFBE;
const bit<32> wq_3_0 = 0xFFFFFFD3;
const bit<32> wq_3_1 = 0x00000003;
const bit<32> wq_3_2 = 0x00000044;
const bit<32> wq_4_0 = 0x00000063;
const bit<32> wq_4_1 = 0xFFFFFFB2;
const bit<32> wq_4_2 = 0xFFFFFFF8;
const bit<32> wq_5_0 = 0x0000003D;
const bit<32> wq_5_1 = 0xFFFFFFFB;
const bit<32> wq_5_2 = 0xFFFFFFD8;

const bit<16> wq_bias_0 = 0x007F;
const bit<16> wq_bias_1 = 0xFFD9;
const bit<16> wq_bias_2 = 0xFFAA;

const bit<32> wk_0_0 = 0x0000003C;
const bit<32> wk_0_1 = 0x00000035;
const bit<32> wk_0_2 = 0xFFFFFFB4;
const bit<32> wk_1_0 = 0xFFFFFFDC;
const bit<32> wk_1_1 = 0x00000013;
const bit<32> wk_1_2 = 0xFFFFFFDC;
const bit<32> wk_2_0 = 0xFFFFFFF9;
const bit<32> wk_2_1 = 0x0000000D;
const bit<32> wk_2_2 = 0xFFFFFFDA;
const bit<32> wk_3_0 = 0xFFFFFF9C;
const bit<32> wk_3_1 = 0xFFFFFFB3;
const bit<32> wk_3_2 = 0xFFFFFFC1;
const bit<32> wk_4_0 = 0x00000002;
const bit<32> wk_4_1 = 0x00000007;
const bit<32> wk_4_2 = 0x00000050;
const bit<32> wk_5_0 = 0x00000012;
const bit<32> wk_5_1 = 0xFFFFFF5D;
const bit<32> wk_5_2 = 0xFFFFFF6D;

const bit<16> wk_bias_0 = 0xFFE3;
const bit<16> wk_bias_1 = 0xFFCA;
const bit<16> wk_bias_2 = 0xFFB7;

const bit<32> wv_0_0 = 0xFFFFFFAF;
const bit<32> wv_0_1 = 0x0000006D;
const bit<32> wv_0_2 = 0xFFFFFFD4;
const bit<32> wv_1_0 = 0xFFFFFFC7;
const bit<32> wv_1_1 = 0x00000060;
const bit<32> wv_1_2 = 0xFFFFFFDC;
const bit<32> wv_2_0 = 0xFFFFFFD1;
const bit<32> wv_2_1 = 0x0000005F;
const bit<32> wv_2_2 = 0xFFFFFFEE;
const bit<32> wv_3_0 = 0x00000043;
const bit<32> wv_3_1 = 0xFFFFFFFC;
const bit<32> wv_3_2 = 0x00000006;
const bit<32> wv_4_0 = 0xFFFFFFFE;
const bit<32> wv_4_1 = 0x00000074;
const bit<32> wv_4_2 = 0x0000004C;
const bit<32> wv_5_0 = 0xFFFFFF95;
const bit<32> wv_5_1 = 0xFFFFFFA8;
const bit<32> wv_5_2 = 0xFFFFFF86;

const bit<32> wv_bias_0 = 0x00000044;
const bit<32> wv_bias_1 = 0xFFFFFFDF;
const bit<32> wv_bias_2 = 0x00000047;
